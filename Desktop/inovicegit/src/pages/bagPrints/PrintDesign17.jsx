                                    ...
                                    return <div className="container_17_old mb_2 mt_2 pt_2 container_margin_left" key={index}>
                                        <div className="border border-black border-2">
                                            ...
                                            <div className="print-sec d_flex footer">
                                                <div className="w17Imp border_right"><div className="upper border_bottom text_center center_item"><p className="semibold" style={{ fontSize: "2.2mm" }}>DIAM.</p></div><div className="lower17 center_item bold separatedfs17old" style={{fontSize:"9.5px"}}>{+(e?.additional?.dia?.diaPcs) + "/" + (e?.additional?.dia?.diaWt)?.toFixed(3)}</div></div>
                                                ...
                                                <div className="w17cs border_right"><div className="upper border_bottom text_center center_item"><p className="semibold" style={{ fontSize: "2.2mm" }}>CS</p></div><div className="lower17 center_item bold separatedfs17old">{+(e?.additional?.clr?.clrPcs) + "/" + +(e?.additional?.clr?.clrWt)?.toFixed(3)}</div></div>
                                                <div className="w_12mm border_right" style={{ borderBottom: "0px solid black" }}><div className="upper"></div><div className="lower17"></div></div>
                                                <div className="w_10 border_right"><div className="upper border_bottom text_center center_item"><p className="semibold" style={{ fontSize: "2.2mm" }}>METAL</p></div><div className="lower17 center_item bold separatedfs17old">{(e?.data?.rd?.["QuotGrossWeight"])?.toFixed(3)}</div></div>
                                                <div className="w_13 border_right" style={{ borderBottom: "0px solid black" }}><div className="upper"></div><div className="lower17"></div></div>
                                                <div className="w_9 border_right"><div className="upper border_bottom text_center center_item"><p className="semibold" style={{ fontSize: "2.2mm" }}>MISC</p></div><div className="lower17 center_item bold separatedfs17old">{(+e?.additional?.misc?.miscWt)?.toFixed(3)}</div></div>
