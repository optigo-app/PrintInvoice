...
//                         index > 0 && <div key={index} className="container ml_2 mb_2 mt_2 pt_2 container_margin_left"></div>
//                     ))}
//                     {
//                         data.map((e, i) => {
//                             return <>
//                                 {e?.additional?.chdata?.length > 0 ? e?.additional?.chdata?.map((chunk, index) => {
//                                     return <div className="container ml_2 mb_2 mt_2 pt_2 container_margin_left" key={index}>
//                                         <div className="border">
//                                             <div className="print_sec d_flex">
//                                                 <div className="print_text border_right">

//                                                     <div className="header_first">
//                                                         <p className='fontsize17'>{e?.data?.rd[0]?.["serialjobno"]}</p>
//                                                         <p className='fontsize17'>{e?.data?.rd[0]?.["Designcode1"]}</p>
...
//                                                             <p className="bold fsize17">{e?.data?.rd[0]?.["CustomerCode"]}</p>
//                                                         </div>
//                                                         <div className="w_25 border_right p_3">
//                                                             <p className="grey bold fsize17 linehP17">SIZE</p>
//                                                             <p className="bold fsize17">{e?.data?.rd[0]?.["Size"]}</p>
//                                                         </div>
//                                                         <div className="w_25 border_right p_3">
//                                                             <p className="grey bold fsize17 linehP17">ORD.DT.</p>
//                                                             <p className="bold fsize17">{e?.data?.rd[0]?.["OrderDate"]}</p>
//                                                         </div>
...
//                                                                 <p className="bold fsize17">{e?.data?.rd[0]?.["promisedate"]}</p>}
//                                                         </div>
//                                                     </div>
//                                                     <div className="printhead_2 border_bottom print_head_2_ins_17" >

//                                                         <p className='px_2 bold line_clamp_17' style={{ fontSize: "12px", lineHeight: "9px", padding: "2px", wordBreak: "break-all" }}>INS :  {(e?.data?.rd[0]?.instructionData === (null || 'null') ? '' : e?.data?.rd[0]?.instructionData?.slice(0, 113))}</p>

//                                                     </div>
//                                                 </div>
//                                                 <div className="print_photo border_bottom" style={{ borderTop: "1px solid black", borderLeft: "1px solid" }}>
//                                                     <img src={e?.additional?.img !== "" ? e?.additional?.img : require("../assets/images/default.jpg")} alt="" onLoad={eve => handleImageLoad(eve, i, data?.length)} onError={e => handleImageError(e)} loading="eager" />
//                                                 </div>
//                                             </div>
...
//                                                 <div className="w_12mm border_right" style={{ borderBottom: "0px solid black" }}><div className="upper"></div><div className="lower17"></div></div>
//                                                 <div className="w_10 border_right"><div className="upper border_bottom text_center center_item"><p className="semibold" style={{ fontSize: "2.2mm" }}>METAL</p></div><div className="lower17 center_item bold">{(e?.data?.rd[0]?.["QuotGrossWeight"]).toFixed(2)}</div></div>
...
//                                         </div>
//                                     </div>;
//                                 }) : <div className="container ml_2 mb_2 mt_2 pt_2 container_margin_left" key={i}>
//                                     <div className="border">
//                                         <div className="print_sec d_flex">
//                                             <div className="print_text border_right">
//                                                 <div className="printhead d_flex justify_content_between ">
//                                                     <p className=" bold pl_3 fontsize17">{e?.data?.rd[0]?.["serialjobno"]}</p>
//                                                     <p className=" bold pr_3 fontsize17" >{e?.data?.rd[0]?.["Designcode1"]}</p>
...
//                                             </div>
//                                             <div className="print_photo border_bottom" style={{ borderTop: "1px solid black", borderLeft: "1px solid" }}>
//                                                 <img src={e?.additional?.img !== "" ? e?.additional?.img : require("../assets/images/default.jpg")} alt="" onError={e => handleImageError(e)} id="img17D" loading="eager"  onLoad={eve => handleImageLoad(eve, i, data?.length)}/>
//                                             </div>
//                                         </div>
//                                         <div className="print_sec d_flex border_bottom">
//                                             <div className="print_table">
...
//                                             </div>
//                                             <div className="BARCODE">
//                                                 {(e?.data?.rd !== 0) && <>{e?.data?.rd[0]?.serialjobno !== undefined && <BarcodeGenerator data={e?.data?.rd[0]?.serialjobno} />}</>}
//                                             </div>
//                                         </div>
//                                         <div className="print-sec d_flex footer">
...
//                                             <div className="w_12mm border_right"><div className="upper"></div><div className="lower17"></div></div>
//                                             <div className="w_10 border_right"><div className="upper border_bottom text_center center_item"><p className="semibold">METAL</p></div><div className="lower17 center_item bold" style={{ borderBottom: "1px solid black" }}>{(e?.data?.rd[0]?.["QuotGrossWeight"])?.toFixed(2)}</div></div>
...
//                                                     <div className="w_25 border_right p_3 bold grey "><p className='fsize17 linehP17' style={{ fontSize: "10px" }}>SALES REP.</p><p className="bold black fsize17 linehP17">{e?.data?.rd[0]?.["SalesrepCode"]}</p></div>
//                                                     <div className="w_19_p border_right p_3 bold grey fsize17"><p className='fsize17 linehP17'>FROS</p><p className="bold black fsize17 linehP17">{e?.data?.rd[0]?.["MetalFrosting"]}</p></div>
//                                                     <div className="w_19_p border_right p_3 bold grey fsize17"><p className='fsize17 linehP17'>LAB</p><p className="bold black fsize17 linehP17">{e?.data?.rd[0]?.["MasterManagement_labname"]}</p></div>
//                                                     <div className="w_37_p p_3 bold grey fsize17"><p className='fsize17 linehP17'>MAKETYPE</p><p className="bold black fsize17 linehP17">{e?.data?.rd[0]?.["mastermanagement_maketypename"]}</p></div>
//                                                 </div>
...
//                                                 <img src={e?.additional?.img !== "" ? e?.additional?.img : require("../assets/images/default.jpg")} alt="" onError={e => handleImageError(e)} loading="eager" onLoad={eve => handleImageLoad(eve, i, data?.length)} id='img17duplicate' />
...
//                                                 {(e?.data?.rd !== 0 && e?.data?.rd !== undefined) && <>{e?.data?.rd[0]?.serialjobno !== undefined && <BarcodeGenerator data={e?.data?.rd[0]?.serialjobno} />}</>}
//                                             </div>
//                                         </div>
//                                     </div>
//                                 </div>
