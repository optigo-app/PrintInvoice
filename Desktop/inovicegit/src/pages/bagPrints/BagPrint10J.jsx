                ...
                return (
                  <>
                    <div className="bag10Afinal">
                      {/* Left Side */}
                      <div key={i} className="container10A spBrderAl d-flex flex-column">
                        {/* Header */}
                          ...
                          <div className="Wdth0 FntSize0">
                            ...
                            <div className="d-flex justify-content-between BrderBtomDRK BrderRigtDRK">
                              ...
                              <div className="Wdth3 SpacLft3">
                                <div className=""><span className="fw-bold">MET. KT :</span>&nbsp; {e?.data?.rd?.tunch ? e.data.rd.tunch.split('K')[0] + 'K' : 'N/A'}</div> {/* Taking Gold Karat Value From This */}
                      ...
                      <div className="container10A spBrderAl">
                        ...
                        <div className="w-100 d-flex FntSize1 BrderBtomDRK">
                          ...
                          <div className="w-50 SpacLft0"><span className="fw-bold">MET KT :</span>  {e?.data?.rd?.tunch ? e.data.rd.tunch.split('K')[0] + 'K' : 'N/A'}</div> {/* Taking Gold Karat Value From This */} 
                        </div>
                        ...
                        <div className="w-100 Higt0 BrderBtomDRK FntSize0 SpacLft0 SpacLft1">
                          <div className="d-flex">
                            <div className="fw-bold">INSTRUCTION :&nbsp;</div>
                            <div className="fw-bold">{e?.data?.rd?.QuoteRemark}</div>
                          </div>
                        </div>
                                  ...
                                  return (
                                    <div key={i} className={`w-100 d-flex ${isLastRow ? '' : 'BrderBtom'}`}>
                                      <div className="Wdth6 d-flex BrderRigtDRK">
                                        <div className="Wdth8 StcMangs2 BrderRigt TrckTxtCntr TxtStart">
                                          {a?.Shapecode}&nbsp;{a?.ColorCode}
                                        </div>
                                        <div className="Wdth9 StcMangs2 BrderRigt TrckTxtCntr TxtStart">
                                          {a?.Sizename}
                                        </div>
