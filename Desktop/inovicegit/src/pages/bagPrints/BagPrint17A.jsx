        ...
        <>
            {
                data?.length === 0 ? <Loader /> : <>
                    ...
                    <div className='samebgp17A'>
                        {Array.from({ length: queries?.pageStart }, (_, index) => (
                            index > 0 && <div key={index} className="bgn17A" style={{ border: "0px" }}></div>
                                            ...
                                            e?.additional?.pages?.length > 0 ? e?.additional?.pages?.map((ele, index) => {
                                                        ...
                                                        <div className='bgn17A'>
                                                            <div className='headn17A'>
                                                                <div className='headInfon17A'>
                                                                    <div className='jobn17A'>
                                                                        <p className='fsn17A'><p className='fsbn17Ajob'>{e?.data?.rd[0]?.serialjobno}</p></p>
                                                                        <p className='fsn17A'>{e?.data?.rd[0]?.Designcode}</p>
                                                                        <p className='fsn17A' style={{ marginRight: "3px" }}>{e?.data?.rd[0]?.MetalType} {e?.data?.rd[0]?.MetalColorCo}</p>
                                                                    </div>
                                                                    <div className='maten17A'>
                                                                        <div className='custn17Amate'><p className='cparan17A'>CUST</p><p className='cparaValn17A'>{e?.data?.rd[0]?.CustomerCode}</p></div>
                                                                        <div className='custn17Amate'><p className='cparan17A'>SIZE</p><p className='cparaValn17A'></p>{e?.data?.rd[0]?.Size}</div>
                                                                        <div className='custn17Amate'><p className='cparan17A'>ORD.DT.</p><p className='cparaValn17A'></p>{e?.data?.rd[0]?.orderDatef ?? ''}</div>
                                                                        <div className='custn17Amate brn17A' ><p className='cpara18A'>DEL.DT.</p><p className='cparaValn17A'></p>{e?.data?.rd[0]?.promiseDatef ?? ''}</div>
                                                                    </div>
                                                                    <div className='insn17A' style={{ color: "red" }}>INS: &nbsp;
                                                                        {(
                                                                            (e?.data?.rd[0]?.officeuse + e?.data?.rd[0]?.ProductInstruction)?.length > 0 &&
                                                                            (e?.data?.rd[0]?.officeuse + e?.data?.rd[0]?.ProductInstruction) !== (null || 'null' || undefined)
                                                                        ) ? (e?.data?.rd[0]?.officeuse + "\u00a0\u00a0" + e?.data?.rd[0]?.ProductInstruction)?.slice(0, 140) : ''}
                                                                    </div>
                                                                </div>
                                                                <div className='imgn17A'>
                                                                    <img src={e?.additional?.img !== "" ? e?.additional?.img : require("../../assets/img/default.jpg")} alt="" onError={e => handleImageError(e)} id="imgn17A" loading="eager"
                                                                        onLoad={eve => handleImageLoad(eve, i, data?.length)} />
                                                                </div>
                                                            </div>
                                                                            ...
                                                                            return (
                                                                                <>
                                                                                    <div className='mateBodyn17A' key={sr}>
                                                                                        <p className='bodycoden17A coden17A'>{a?.ConcatedFullShapeQualityColorName?.toUpperCase()}</p>
                                                                                        <p className='bodyn17A sizen17A' style={{ justifyContent: "flex-start", paddingLeft: "2px" }}>{a?.Sizename}</p>
                                                                                        <p className='bodyn17A pcsn17A'>{a?.ActualPcs}</p>
                                                                                        <p className='bodyn17A pcsn17A'>{a?.ActualWeight?.toFixed(3)}</p>
                                                            ...
                                                            <div className='footern17A'>
                                                                <div className='dian17A'>
                                                                    ...
                                                                    <div className='fsn17A'>{e?.additional?.dia?.ActualPcs}/{e?.additional?.dia?.ActualWeight?.toFixed(3)}</div>
                                                                    <div className='fsn17A'></div>
                                                                </div>
                                                                <div className='dian17A'>
                                                                    <div className='fsn17A brbn17A'>CS</div>
                                                                    <div className='fsn17A'>{e?.additional?.clr?.ActualPcs}/{e?.additional?.clr?.ActualWeight?.toFixed(3)}</div>
                                                                    <div className='fsn17A'></div>
                                                                </div>
                                                                <div className='miscn17A'>
                                                                    <div className='fsn17A brbn17A'>METAL</div>
                                                                    <div className='fsn17A'>{e?.data?.rd[0]?.QuotGrossWeight?.toFixed(3)}</div>
                                                                    <div className='fsn17A'></div>
                                                                </div>
                                                                <div className='miscn17A' style={{ marginRight: "32.5px" }}>
                                                                    <div className='fsn17A brbn17A'>MISC</div>
                                                                    <div className='fsn17A'>{e?.additional?.misc?.ActualWeight?.toFixed(3)}</div>
                                                                    <div className='fsn17A'></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className='headn17A'>
                                                    <div className='headInfon17A'>
                                                        ...
                                                        <div className='maten17A'>
                                                            <div className='custn17Amate'><p className='cparan17A'>CUST</p><p className='cparaValn17A'></p>{e?.data?.rd[0]?.CustomerCode}</div>
                                                            <div className='custn17Amate'><p className='cparan17A'>SIZE</p><p className='cparaValn17A'></p>{e?.data?.rd[0]?.Size}</div>
                                                            <div className='custn17Amate'><p className='cparan17A'>ORD.DT.</p><p className='cparaValn17A'></p>{e?.data?.rd[0]?.orderDatef}</div>
                                                            <div className='custn17Amate brn17A' ><p className='cpara18A'>DEL.DT.</p><p className='cparaValn17A'>{e?.data?.rd[0]?.promiseDatef}</p></div>
                                                        </div>
                                                        <div className='insn17A'>INS :
                                                            {(
                                                                (e?.data?.rd[0]?.officeuse + e?.data?.rd[0]?.ProductInstruction)?.length > 0 &&
                                                                (e?.data?.rd[0]?.officeuse + e?.data?.rd[0]?.ProductInstruction) !== ('null' || null || undefined)
                                                            ) ? (e?.data?.rd[0]?.officeuse + "   " + e?.data?.rd[0]?.ProductInstruction)?.slice(0, 140) : ''}
                                                    ...
                                                    <div className='imgn17A'>
                                                        <img src={e?.additional?.img !== "" ? e?.additional?.img : require("../../assets/img/default.jpg")} alt="" onError={e => handleImageError(e)} id="img18A" loading="eager" onLoad={eve => handleImageLoad(eve, i, data?.length)} />
                                                    </div>
                                                </div>
                                                <div className='mateTablen17A'>
                                                    <div>
                        ...
                        <div className='mateBody18A' key={sr}>
                            ...
                            <p className='body18A wt18A'></p>
                                                ...
                                                <div className='footern17A'>
                                                    ...
                                                    <div className='miscn17A' style={{ marginRight: "3rem" }}>
                                                        <div className='fsn17A brbn17A'>MISC</div>
                                        ...
                                        <div className='bgn17A'>
                                            <div className='headn17AD'>
                                                <div className='headInfon17AD'>
                                                    <div className='jobn17A'>
                                                        <p className='fs18A'><p className='fsbn17Ajob'>{e?.data?.rd[0]?.serialjobno}</p></p>

                                                        <p className='fsn17A'>{e?.data?.rd[0]?.Designcode}</p>

                                                        <p className='fsn17A'>{e?.data?.rd[0]?.MetalType} {e?.data?.rd[0]?.MetalColorCo}</p>

                                                    </div>
                                                    <div className='Dmaten17A'>
                                                        <div className='custn17Amate'><p className='cparan17A'>SALES REP.</p><p className='cparaValn17A'>{e?.data?.rd[0]?.SalesrepCode}</p></div>

                                                        <div className='custn17Amate'><p className='cparan17A'>FROS</p><p className='cparaValn17A'>{e?.data?.rd[0]?.MetalFrosting}</p></div>

                                                        <div className='custn17Amate'><p className='cparan17A'>LAB</p><p className='cparaValn17A'>{e?.data?.rd[0]?.MasterManagement_labname}</p></div>

                                                        <div className='custn17Amate brn17A' ><p className='cparan17A'>MAKETYPE</p><p className='cparaValn17A'>{e?.data?.rd[0]?.mastermanagement_maketypename}</p></div>

                                                    </div>
                                                    <div className='testn17A'><p>{e?.data?.rd[0]?.PO}</p></div>

                                                    <div className='tronn17A'>
                                                        <p className='pn17AD'>Y TR NO</p><p className='pn17AD'>W TR NO</p><p className='pn17AD'>P TR NO</p><p className='pn17AD'>Y CST WT.</p><p className='pn17AD'>W CST WT.</p><p className='pn17AD' style={{ borderRight: "0px" }}>P CST WT.</p>
                                                    </div>
                                                ...
                                                <div className='imgn17AD'>
                                                    <img src={e?.additional?.img !== "" ? e?.additional?.img : require("../../assets/img/default.jpg")} alt="" onError={e => handleImageError(e)} id="imgn17AD" loading="eager" onLoad={eve => handleImageLoad(eve, i, data?.length)} />
                                                </div>
                                            </div>
                                            <section>
                                            ...
                                            <main className='mainn17A'>
                                                <div className='theadrown17A'>
                                                    ...
                                                    <p className='thrown17A workn17Aw br177Anone'>WORKER</p>
                                                </div>
                                                <div className='theadrown17A'>
                                                ...
                                                <div className='theadrown17A' style={{ borderBottom: "0px" }}>
