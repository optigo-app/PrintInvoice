                    ...
                    <div className='print1A'>
                        {
                            ...
                            Array.from({ length: queries?.pageStart }, (_, indexs) => (
                                                        ...
                                                        <div className='mainbag1A' key={index}>
                                                            <div className='print1AStartPart'>
                                                                <div className='print1A_header'>
                                                                    <div className='print1A_header_bagInfoPart'>
                                                                        ...
                                                                        <div className='print1AMaterial'>
                                                                            <div className='print1AMaterialCG'>
                                                                                ...
                                                                                <div className='custHead1A'>{e?.data?.rd[0]?.CustomerCode?.toUpperCase()}</div>
                                                                                <div className='custCode1A'>
                                                                                    <b>GOLD</b></div>
                                                                                <div className='cst1A'><b>DIA</b></div>
                                                                                <div className='cst1A' style={{ borderRight: "0px" }}><b>CST</b></div>
                                                                            </div>
                                                                            <div className='print1AMaterialCG'>
                                                                            ...
                                                                            <div className='print1AMaterialCG'>
                                                                                ...
                                                                                <div className='cst1A'><b>BAG DT</b></div>
                                                                                <div className='cst1A' style={{ borderRight: "0px", fontSize: "11.5px" }}>{e?.data?.rd[0]?.orderDatef?.toUpperCase()}</div></div>
                                                                            {/* {
                                                                                ele.data.map((el, ins) => {
                                                                    ...
                                                                    <div className='print1A_header_bagImgPart2'><img src={e?.additional?.img !== "" ? e?.additional?.img : require("../../assets/img/default.jpg")} id="print1AImg" alt="" onError={e => handleImageError(e)} loading="eager" /></div>
                                                                </div>

                                                            </div>
                                                            <div className='print1AtableBarcode'>
                                                                <div className='midpart'>
                                                                    <div className='print1AMiddlePart' style={{ width: "260px" }}>
                                                                                    ...
                                                                                    <div key={i}>

                                                                                        {
                                                                                            ...
                                                                                            ((e?.heading === "DIAMOND DETAIL") || (e?.heading === "COLOR STONE DETAIL") || (e?.heading === "MISC DETAIL") || (e?.heading === "FINDING DETAIL"))
                                                                                                ?
                                                                                                <div className='print1AMidBody' style={(i === 0 && e.heading !== '') ? { display: "" } : {}} key={i}>
                                                                                    ...
                                                                                    <>
                                                                                        {
                                                                                            i !== 0 ?
                                                                                                <div className='print1AMidBody' key={i}>
                                                                                                    ...
                                                                                                    <div className='pcswt1A'>
                                                                                                        <div className='actualPcsWt'>
                                                                                                            ...
                                                                                                            <div className='' style={{ borderRight: "0px", width: "38px" }}>{e?.ActualWeight ?? ''}</div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div className=''>
                                                                                                        <div className=''>
                                                                                                ...
                                                                                                </div> : <div className='print1AMidBody' style={{ display: "none" }} key={i}>
                                                                                                    <div className='print1ARM RMW' >{e?.Shapename ?? ''}</div>
                                                                                                    <div className='sizename1A'>{e?.Sizename ?? ''}</div>
                                                                                                    <div className='pcswt1A'>
                                                                                                        <div className='actualPcsWt'>
...
=======
                                                                    <div style={{ fontSize: "14px", paddingLeft: "2px", paddingTop: "2px", lineHeight: "14px", fontSize:"12px" }}><b>INSTRUCTION:</b><span style={{ color: "red" }}>{(e.data.rd[0].officeuse + e?.data?.rd[0]?.custInstruction + e.data.rd[0].ProductInstruction).length > 0 ? ((e.data.rd[0].officeuse + e?.data?.rd[0]?.custInstruction + e.data.rd[0].ProductInstruction)?.slice(0, 96) == (null || 'null') ? '' : (e?.data?.rd[0]?.officeuse + " " + e?.data?.rd[0]?.custInstruction + " " + e?.data?.rd[0]?.ProductInstruction)?.toUpperCase()?.slice(0, 88)) : ''}</span></div>
>>>>>>> e428fbe7c3a404ab1d34679f866a7eca0c6538d8
                                                                </div>
                                                ...
                                                <div className='print1AStartPart'>
                                                    <div className='print1A_header'>
                                                        <div className='print1A_header_bagInfoPart'>
                                                            <div className='print1A_header_bagInfoPart1'>
                                                                <div className='print1AJobNo' style={{ fontSize: "12px", lineHeight: "8px" }}>BAG {e?.data?.rd[0]?.serialjobno}</div>
                                                                <div className='print1AJobNo' style={{ lineHeight: "8px" }}>{e?.data?.rd[0]?.Designcode}</div>
                                                                <div className='print1AJobNo' style={{ lineHeight: "8px" }}>{e?.data?.rd[0]?.MetalType}</div>
                                                                <div className='print1AJobNo' style={{ paddingRight: "3px", lineHeight: "8px" }}>{e?.data?.rd[0]?.MetalColorCo}</div>
                                                            </div>

                                                            <div className='print1AMaterial'>
                                                                <div className='print1AMaterialCG'>
                                                                    <div className='g1A'>CUST.</div>
                                                                    <div className='custHead1A'>{e?.data?.rd[0]?.CustomerCode}</div>
                                                                    <div className='custCode1A'>
                                                                        <b>GOLD</b></div>
                                                                    <div className='cst1A'><b>DIA</b></div>
                                                                    <div className='cst1A' style={{ borderRight: "0px" }}><b>CST</b></div>
                                                                ...
                                                                <div className='print1AMaterialCG'>
                                                                    <div className='g1A'>SIZE</div>
                                                                    <div className='custHead1A'>{e?.data?.rd[0]?.Size}</div>
                                                                    <div className='custCode1A'>{e?.data?.rd[0]?.MetalWeight?.toFixed(3)}</div>
                                                                ...
                                                                <div className='print1AMaterialCG'>
                                                                    <div className='g1A' style={{ width: "37px" }}>PO</div>
                                                                    <div className='custHead1A' style={{ "width": "100px" }}>{e?.data?.rd[0]?.PO}</div>
                                                                    <div className='cst1A'><b>BAG DT</b></div>
                                                                    <div className='cst1A' style={{ borderRight: "0px" }}>{e?.data?.rd[0]?.OrderDate}</div></div>
                                                ...
                                                <div className='print1AtableBarcode'>
                                                    <div className='midpart'>
                                                        ...
                                                        <div style={{ fontSize: "14px", borderRight: "1px solid black", height: "34px" }}><b>INSTRUCTION:</b><span style={{ color: "red" }}>{(e?.data?.rd[0]?.officeuse + e?.data?.rd[0]?.custInstruction + e?.data?.rd[0]?.ProductInstruction)?.length > 0 ? ((e?.data?.rd[0]?.officeuse + e?.data?.rd[0]?.custInstruction + e?.data?.rd[0]?.ProductInstruction)?.slice(0, 95) == (null || 'null') ? '' : (e?.data?.rd[0]?.officeuse + e?.data?.rd[0]?.e?.data?.rd[0]?.custInstruction + e?.data?.rd[0]?.ProductInstruction)?.slice(0, 95)) : ''}</span></div>
                                                    </div>
