                              ...
                              <div className="jobInfo6A">
                                <div className="jobInfo6Aheader">
                                  ...
                                  >
                                    ...
                                    <div className="job6Ahww">
                                      {e?.data?.rd[0]?.MetalWeight?.toFixed(3)}/
                                  ...
                                  <div className="cust6A">
                                    <p className="f6A">
                                      ...
                                      <span className="f6A ">
                                        ...
                                        e?.data?.rd[0]?.ProductInstruction !==
                                          undefined
                                          ? e?.data?.rd[0]?.ProductInstruction?.slice(
                                              0,
                                              120
                                            )
                                          : ""}
                        ...
                        <div className="jobInfo6A">
                          <div className="jobInfo6Aheader">
                            ...
                            >
                              ...
                              <div className="job6Ahww">
                                {e?.data?.rd[0]?.MetalWeight?.toFixed(2)}/
                                {e?.data?.rd[0]?.ActualGrossweight?.toFixed(2)}
                              </div>
                              <div className="job6Ahww borderRight6A">
                                {e?.data?.rd[0]?.orderDatef ?? ""}
                              </div>
