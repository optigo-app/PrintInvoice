        ...
        data.length === 0 ? <Loader /> : <><div className="print_btn"><button className="btn_white blue print_btn" onClick={(e) => handlePrint(e)}>
          ...
          <div className='print7A'>
            {Array.from({ length: queries.pageStart }, (_, index) => (
              index > 0 && <div key={index} className="container7A" style={{ border: "0px" }}></div>
            ))}
            {
              data?.length > 0 && data?.map((e, ins) => {
                      ...
                      e?.additional?.pages?.length > 0 ? e?.additional?.pages.map((ele) => {
                              ...
                              <div className='head7A'>
                                <div className='head7AjobInfo'>
                                  <div className='head7AjobInfoJobNO'>
                                    <div>Ord. : {e?.data?.rd[0]?.orderDatef ?? ''}</div>
                                    <div>Due : {e?.data?.rd[0]?.promiseDatef ?? ''}</div>
                                    <div><b>{e?.data?.rd[0]?.serialjobno}</b></div>
                                  </div>
                                  <div className='party7A'>
                                    <div>Party: <b>{e?.data?.rd[0]?.CustomerCode}</b></div>
                                    <div style={{ paddingBottom: "4px" }}>Ord No. : <b>{e?.data?.rd[0]?.OrderNo}</b></div>
                                  </div>
                                  <div className='party7A'>
                                    <div>Dg No. : <b>{e?.data?.rd[0]?.Designcode}</b></div>
                                    <div className='barcode7A'>{(e?.data?.rd?.length !== 0 && e?.data?.rd !== undefined) && <>{e?.data?.rd[0]?.serialjobno !== undefined && <BarcodeGenerator data={e?.data?.rd[0]?.serialjobno} />}</>}</div>
                                  </div>
                                  <div className='party7A'>
                                    <div>Size: {e?.data?.rd[0]?.Size}</div>
                                    <div>({e?.data?.rd[0]?.Quantity})Pcs</div>
                                    <div>{e?.data?.rd[0]?.prioritycode}</div>
                                  </div>
                              ...
                              <div className='main7A'>
                                <div className='main7AEntry'>
                                  ...
                                  <div>
                                    ...
                                    <div className='tableHead7B' style={{ borderTop: "1px solid #989898" }}>
                                      <div className='dept7A' style={{ width: "63px" }}>Dept</div><div className='dept7A'>WrKr</div><div className='dept7A'>In Wt</div><div className='dept7A'>OutWt</div><div className='dept7A'>D Wt</div><div className='dept7A' style={{ borderRight: "0px" }}>(%)</div>
                                    </div>
                                            ...
                                            return (
                                              <>
                                                <div className='dis7A'>
                                                  ...
                                                  <div className='dept7AE'></div>
                                                  <div className='dept7AE'></div>
                                                  <div className='dept7AE' style={{ borderRight: "0px" }}></div>
                                                </div>
                                              </>
                                            );
                                          })
                                    ...
                                    <div className='tableHead7B'>
                                      <div className='dept7A' style={{ width: "63px" }}>MFG</div><div className='dept7A'>Gwt</div><div className='dept7A'>Dwt</div><div className='dept7A'>Cwt</div><div className='dept7A'>Nwt</div><div className='dept7A' style={{ borderRight: "0px" }}>Sign</div>
                                    </div>
                                    <div className='tableHead7B'>
                                      <div className='dept7A' style={{ width: "63px", height: "16px" }}></div><div className='dept7A'></div><div className='dept7A'></div><div className='dept7A'></div><div className='dept7A'></div><div className='dept7A' style={{ borderRight: "0px" }}></div>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div style={{ height: "4px", width: "269px" }}></div>
                              <div className='tableHead7B' style={{ fontWeight: "bold", borderTop: "1px solid #989898" }}>
                                <div className='dept7A fs7A' style={{ width: "63px" }}>Gr. Wt	</div><div className='dept7A fs7A'>Chaki Post</div><div className='dept7A fs7A'>Taar</div><div className='dept7A fs7A'>Extra Metal</div><div className='dept7A fs7A' style={{ borderRight: "0px" }}>Other</div>
                              </div>
                              <div className='tableHead7B' style={{ fontWeight: "bold", height: "16px" }}>
                                <div className='dept7A' style={{ width: "63px" }}></div><div className='dept7A'></div><div className='dept7A'></div><div className='dept7A'></div><div className='dept7A' style={{ borderRight: "0px" }}></div>
                              </div>

                              <div className='footer7A'><b style={{ lineHeight: "8px", marginTop: "3px", padding: "2px" }}>Remark: {(e?.data?.rd[0]?.custInstruction + e?.data?.rd[0]?.QuoteRemark + e?.data?.rd[0]?.ProductInstruction)?.length > 0 ? ((e?.data?.rd[0]?.custInstruction + e?.data?.rd[0]?.QuoteRemark + e?.data?.rd[0]?.ProductInstruction == (null || 'null')) ? '' : (e?.data?.rd[0]?.custInstruction + e?.data?.rd[0]?.QuoteRemark + e?.data?.rd[0]?.ProductInstruction)?.slice(0, 200)) : ''}</b></div>
                            </div>
                          </>
                        );
                      }) : <div className='container7A'>
                        <div className='head7A'>
                          <div className='head7AjobInfo'>
                            ...
                            <div className='party7A'>
                              <div>Party: <b>{e?.data?.rd[0]?.CustomerCode}</b></div>
                              <div>Ord No. : <b>{e?.data?.rd[0]?.OrderNo}</b></div>
                            </div>
                            <div className='party7A'>
                              <div>Dg No. : <b>{e?.data?.rd[0]?.Designcode}</b></div>
                              <div class
                                Name='barcode7A'>{(e?.data?.rd?.length !== 0 && e?.data?.rd !== undefined) && <>{e?.data?.rd[0]?.serialjobno !== undefined && <BarcodeGenerator data={e?.data?.rd[0]?.serialjobno} />}</>}</div>
                            </div>
                            <div className='party7A'>
                              <div>Size: {e?.data?.rd[0]?.Size}</div>
                              <div>(1)Pcs</div>
                            ...
                            <div className='mat7AInfo'>
                              <div className='pcswt7A'>
                                ...
                                <div className='net7A'><b>Gr Wt.</b></div>
                                <div className='net7A'>{e?.data?.rd[0]?.ActualGrossweight}</div>
                              </div>
                              <div className='pcswt7A'>
                                <div className='net7A'><b>Dia Pcs:</b></div>
                          ...
                          <div className='imgSize7A'> <img src={e?.additional?.img !== "" ? e?.additional?.img : require("../../assets/img/default.jpg")} id="img7A" alt="" onError={e => handleImageError(e)} loading="eager" onLoad={eve => handleImageLoad(eve, ins, data?.length)} /><div className='borderBottom7A' style={{ fontSize: "11px", lineHeight: "8px", padding: "2px", height: "22px" }}>{e?.data?.rd[0]?.MetalType}{e?.data?.rd[0]?.MetalColorCo}</div></div>
                          {/* <div className='imgSize7A'><div className='img7A'>img</div><div className='borderBottom7A'>GOLD 18K YL</div></div> */}
                        </div>
                        <div className='main7A'>
                          <div className='main7AEntry'>
                            <div style={{ height: "13px" }}></div>
                            <div className='tableHead7A' style={{ borderBottom: "1px solid #989898" }}>
                              <div className='type7A'><p className='w7A'>Type</p><p className='w7A'>Purity</p><p className='w7A'>Color</p></div>
                              <div className='type7B'><p className='size7A'>Size</p><p className='size7A'>Pcs</p><p className='size7A' style={{ borderRight: "0px" }}>Wt.</p></div>
                            </div>
                            <div className='tableHead7B'>
                              <div className='dept7A' style={{ width: "63px" }}>Dept</div><div className='dept7A'>WrKr</div><div className='dept7A'>In Wt</div><div className='dept7A'>OutWt</div><div className='dept7A'>D Wt</div><div className='dept7A' style={{ borderRight: "0px" }}>(%)</div>
                            </div>
                        ...
                        <div className='tableHead7B' style={{ fontWeight: "bold", height: "20px" }}>
                          <div className='dept7A' style={{ width: "63px" }}></div><div className='dept7A'></div><div className='dept7A'></div><div className='dept7A'></div><div className='dept7A' style={{ borderRight: "0px" }}></div>
                        </div>

                        <div className='footer7A'><b>Remark: {(e?.data?.rd[0]?.custInstruction + e?.data?.rd[0]?.QuoteRemark + e?.data?.rd[0]?.ProductInstruction)?.length > 0 ? ((e?.data?.rd[0]?.custInstruction + e?.data?.rd[0]?.QuoteRemark + e?.data?.rd[0]?.ProductInstruction == (null || 'null')) ? '' : (e?.data?.rd[0]?.custInstruction + e?.data?.rd[0]?.QuoteRemark + e?.data?.rd[0]?.ProductInstruction)?.slice(0, 131)) : ''}</b></div>
                      </div>
                    }
                  </>
                );
