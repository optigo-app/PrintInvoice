            ...
            <div className={`container max_width_container pad_60_allPrint ${style?.detailPrint2} pt-2`} >
                ...
                {/* <div className='border-start border-end border-black'>
                    <div className="d-flex border-top">
                        <div className={`${style?.sr} border-bottom text-center border-end d-flex justify-content-center align-items-center`}><p>1</p></div>
                        <div className={`${style?.design} border-bottom border-end`}>
                            <div className="d-flex flex-column justify-content-between h-100">
                                <div>
                                    ...
                                    <img src="http://zen/R50B3/UFS/ufs2/orail228FT0OWNGEI6DC3BVS/Design_Image/bD8ZTq6u5WMDE0ODkxMQ==/Red_Thumb/0148911_22112023120600745.jpg" alt="" width={75} height={75} className='mx-auto d-block' />
                                </div>
                                <div className="border-top" style={{ minHeight: "13.5px" }}>
                                    <p className="fw-bold text-center">10.000 gm Gross</p>
                                </div>
                            </div>
                        </div>
                        <div className={`${style?.diamond} border-bottom  border-end`}>
                            <div className="d-flex h-100 flex-column justify-content-between">
                                <div>
                                    <div className="d-flex">
                                        <div className='col-3'><p className=''>vvs</p></div>
                                        <div className='col-3 text-end'><p className='text-end'>0.080</p></div>
                                        <div className='col-3 text-end'><p className='text-end'>1,000.00</p></div>
                                        <div className='col-3 text-end'><p className='text-end'>80.00</p></div>
                                    </div>
                                </div>
                                <div className="border-top d-flex lightGrey" style={{ minHeight: "13.5px" }}>
                                    <p className="text-center col-3 fw-semibold">asdasd</p>
                                    <p className="text-center col-3 fw-semibold">asdasd</p>
                                    <p className="text-center col-3 fw-semibold">asdasd</p>
                                    <p className="text-center col-3 fw-semibold">asdasd</p>
                                </div>
                            ...
                            <div className="d-flex h-100 flex-column justify-content-between">
                                <div>
                                    <div className="d-flex h-100">
                                        <div className='col-3'><p className='border-end border-bottom'>GOLD 18K	</p></div>
                                        <div className='col-3'><p className='border-end border-bottom text-end'>10.000</p></div>
                                        <div className='col-3'><p className='border-end border-bottom text-end'>10.084</p></div>
                                        <div className='col-3'><p className='border-end border-bottom text-end'>57,478.80</p></div>
                                    </div>
                                </div>
                                <div className="border-top d-flex lightGrey">
                                    <div className='col-3'><p className='fw-semibold'></p></div>
                                    <div className='col-3'><p className='fw-semibold text-end'>10.000</p></div>
                                    <div className='col-3'><p className='fw-semibold text-end'>10.084</p></div>
                                    <div className='col-3'><p className='fw-semibold text-end'>57,478.80</p></div>
                                </div>
                            </div>
                        </div>
                        <div className={`${style?.stone} border-bottom  border-end`}>
                            <div className="d-flex h-100 flex-column justify-content-between">
                                <div>
                                    <div className="d-flex ">
                                        <div className='col-6'><p className='text-end'>Code</p></div>
                                        <div className='col-6'><p className='text-end'>Amount</p></div>
                                    </div>
                                </div>
                                <div className="border-top lightGrey">
                                    <p className='text-end fw-semibold'>Amount</p>
                                </div>
                            </div>
                        </div>
                        <div className={`${style?.other} border-bottom  border-end text-end`}>
                            <div className="d-flex h-100 flex-column justify-content-between">
                                <div>
                                    <p className='text-end'>Other Amount</p>
                                </div>
                                <div className='border-top lightGrey'>
                                    <p className='text-end fw-semibold'> Amount</p>
                                </div>
                        ...
                        <div className={`${style?.labour} border-bottom  border-end text-end`}>
                            <div className="d-flex h-100 flex-column justify-content-between">
                                <div>
                                    <p className='text-end'>Labour Amount</p>
                                </div>
                                <div className='border-top lightGrey'>
                                    <p className='text-end fw-semibold'> Amount</p>
                                </div>
