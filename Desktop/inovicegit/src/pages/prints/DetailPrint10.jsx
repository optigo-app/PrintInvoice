    ...
    <>
      <div className="containerdp10">
        ...
        <div className="subheaderdp10">
          ...
          <div className="subdiv3dp10 fsgdp10 border-end">
            ...
            <div className="d-flex justify-content-end mt-5 px-2 fw-bold">
              Gold Rate {result?.header?.MetalRate24K?.toFixed(2)} Per Gram
            </div>
          </div>
        </div>
        {/* table */}
        <div className="tabledp10">
                ...
                <div className="tbrowdp10 h-100" key={i}>
                  ...
                  <div className="tbcol2dp10">
                    ...
                    <div className="centerdp10">
                      Tunch : &nbsp;<b className="fsgdp10">{e?.Tunch?.toFixed(3)}</b>
                    </div>
                    <div className="centerdp10">
                      <b className="fsgdp10">{e?.grosswt?.toFixed(3)} gm</b>&nbsp; Gross
                    </div>
                    <div className="centerdp10">
                      {" "}
                      {e?.Size === "" ? "" : `Size : ${e?.Size}`}
                ...
                {result?.allTaxes?.map((e, i) => {
                  return (
                    <div className="d-flex justify-content-between" key={i}>
                      ...
                      <div className="w-50 end_dp10 pe-2">{e?.amount}</div>
                    </div>
                  );
                })}
                <div className="d-flex justify-content-between">
          ...
          >
            <div className="centerdp10 brR_dp10" style={{ width: "12%" }}>
              Total
            </div>
            <div className="col3dp10 d-flex align-items-center brR_dp10">
              ...
              {/* <div className="theadsubcol1_dp10"></div> */}
              <div className="theadsubcol1_dp10 end_dp10 pe-1" style={{width:"33.332%"}}>
          ...
          <div className="d-flex justify-content-between mt-1 summarydp10">
              ...
              <div className="d-flex w-100 fsgdp10">
                <div className="w-50 border-end border-bottom border-start">
                  ...
                  <div className="d-flex justify-content-between px-1">
                    ...
                    <div className="w-50 end_dp10 pe-1">
                      {result?.mainTotal?.netwtWithLossWt?.toFixed(3)} gm
                    </div>
                  </div>
                  <div className="d-flex justify-content-between px-1">
                ...
                <div className="w-50 border-end border-bottom">
                  <div className="d-flex justify-content-between px-1">
                    ...
                    <div className="w-50 end_dp10">{formatAmount(result?.mainTotal?.metal?.Amount)}</div>
                  </div>
                  <div className="d-flex justify-content-between px-1">
                  ...
                  <div className="d-flex justify-content-between px-1">
                    ...
                    <div className="w-50 end_dp10">{formatAmount(result?.mainTotal?.total_other)}</div>
                  </div>
                  <div className="d-flex justify-content-between px-1">
                    <div className="w-50 fw-bold">
                      {result?.header?.AddLess > 0 ? "ADD" : "LESS"}
                    </div>
                    <div className="w-50 end_dp10">{result?.header?.AddLess}</div>
                  </div>
                </div>
              </div>
              ...
              {diamondWise?.map((e, i) => {
                return (
                  <div className="d-flex justify-content-between px-1" key={i}>
                    <div className="fw-bold w-50">{e?.ShapeName} {e?.QualityName} {e?.Colorname}</div>
                    <div className="w-50 end_dp10">{e?.Pcs} / {e?.Wt?.toFixed(3)} cts</div>
                  </div>
                );
              })}
            ...
            <div className="oth_sum_dp10 fsgdp10">
              ...
              <div className="d-flex justify-content-between w-100 px-1 border p-1">
                <div className="w-50 fw-bold centerdp10">RATE IN 24KT</div>
            ...
            <div className="remark_sum_dp10 fsgdp10">
              ...
              <div className="border p-1">{result?.header?.PrintRemark}</div>
            </div>
