...
import { apiCall, handlePrint, taxGenrator, isObjectEmpty, handleImageError, NumberWithCommas, fixedValues } from "../../GlobalFunctions";
...
const HallmarkItemWisePrint = ({ token, invoiceNo, printName, urls, evn }) => {
    ...
    const loadData = (data) => {
        ...
        //     let findIndex = finalArr.findIndex(ele=>e?.SubCategoryname === ele?.SubCategoryname && e?.MetalType === ele?.MetalType && e?.MetalPurity === ele?.MetalPurity);
        //     if(findIndex === -1){
        //         finalArr.push(e);
        //     }else{
        //         finalArr[findIndex].PackageWt += e?.PackageWt;
        //         finalArr[findIndex].count += e?.count;
        //         finalArr[findIndex].diamondPcs += e?.diamondPcs;
        //         finalArr[findIndex].diamondWt += e?.diamondWt;
        //         finalArr[findIndex].colorStonePcs += e?.colorStonePcs;
        //         finalArr[findIndex].colorStoneWt += e?.colorStoneWt;
