...
const EstimatePrint = ({ urls, token, invoiceNo, printName, evn }) => {
    ...
    const caiculateMaterial = (data) => {
        ...
        totals.finalAmount += totals.totalamount + data?.BillPrint_Json[0]?.AddLess - data?.BillPrint_Json[0]?.Privilege_discount;
        ...
        resultArr.forEach((e, i) => {
            if (e?.GroupJob === "") {
                ...
                let findRecord = finalArr.findIndex((ele, ind) => ele?.GroupJob === e?.GroupJob);
                if (findRecord === -1) {
                    finalArr.push(e);
                } else {
                    let obj = { ...e };
                    ...
                    otherAmountDetails.forEach((elee, indd) => {
                        let findOther = blankOtherAmtDetails.findIndex((elem, index) => elem?.label === elee?.label);
                        if (findOther === -1) {
                            blankOtherAmtDetails.push(elee);
                        } else {
                            blankOtherAmtDetails[findOther].value = +blankOtherAmtDetails[findOther].value + +elee.value;
                        }
                    });
                    ...
                    finalArr[findRecord].colorStonesTotal.amount += obj?.colorStonesTotal.amount;
                    finalArr[findRecord].colorStonesTotal.pcs += obj?.colorStonesTotal.pcs;
                    finalArr[findRecord].colorStonesTotal.weight += obj?.colorStonesTotal.weight;
            ...
            <div className="my-2 w-100" >
                        ...
                        return <div className="d-flex border-bottom recordEstimatePrint overflow-hidden " key={i}>
                            ...
                            <div className="designEstimatePrint border-end p_1Estimate">
                                ...
                                <div>
                                    ...
                                    <p className='text-center'><span className='fw-bold'>{fixedValues(e?.grosswt, 3)} gm</span>  Gross </p>
                            ...
                            <div className="diamondEstimatePrint border-end position-relative">
                                ...
                                <div className={`d-flex totalBgEstimatePrint position-absolute bottom-0 height_28_5_estimatePrint w-100 border-top ${e?.diamonds.length === 0 && "border-top height_29_5_estimatePrint"}`}>
                                    <div className='width20EstimatePrint p_1Estimate'><p className='fw-bold'></p></div>
                                    <div className='width20EstimatePrint p_1Estimate'><p className='fw-bold'></p></div>
                                    <div className='width20EstimatePrint p_1Estimate d-flex align-items-center justify-content-end'><p className='text-end fw-bold'>{e?.diamonds.length !== 0 && <>{NumberWithCommas(e?.diamondTotal?.pcs, 0)}</>}</p></div>
                                    <div className='width20EstimatePrint p_1Estimate d-flex align-items-center justify-content-end'><p className='text-end fw-bold'>{e?.diamonds.length !== 0 && <>{fixedValues(e?.diamondTotal?.weight, 3)}</>}</p></div>
                                    ...
                                    <div className='width20EstimatePrint p_1Estimate d-flex align-items-center justify-content-end'><p className='text-end fw-bold'>{e?.diamonds.length !== 0 && <>{NumberWithCommas(e?.diamondTotal?.amount, 2)}</>}</p></div>
                                </div>
                            </div>
                            ...
                            <div className="stoneEstimatePrint border-end position-relative">
                                ...
                                <div className={`d-flex totalBgEstimatePrint position-absolute bottom-0 height_28_5_estimatePrint w-100 ${e?.colorStones.length === 0 && "border-top height_29_5_estimatePrint"}`}>
                                    ...
                                    <div className='width20EstimatePrint p_1Estimate'><p></p></div>
                                    <div className='width20EstimatePrint p_1Estimate d-flex align-items-center justify-content-end'><p className='text-end fw-bold'>{(e?.colorStones.length > 0 || e?.mics.length > 0) && <>{NumberWithCommas(e?.colorStonesTotal?.pcs + e?.miscsTotal?.pcs, 0)}</>}</p></div>
                                    <div className='width20EstimatePrint p_1Estimate d-flex align-items-center justify-content-end'><p className='text-end fw-bold'>{(e?.colorStones.length > 0 || e?.mics.length > 0) && <>{fixedValues(e?.colorStonesTotal?.weight + e?.miscsTotal?.weight, 3)}</>}</p></div>
                                    <div className='width20EstimatePrint p_1Estimate d-flex align-items-center justify-content-end'><p className='text-end fw-bold'></p></div>
                                    <div className='width20EstimatePrint p_1Estimate d-flex align-items-center justify-content-end'><p className='text-end fw-bold'>{(e?.colorStones.length > 0 || e?.mics.length > 0) && <>{NumberWithCommas(e?.colorStonesTotal?.amount + e?.miscsTotal?.amount, 2)}</>}</p></div>
                                </div>
                            </div>
                                ...
                                <div className='h-100 d-grid pad_bot_29_estimatePrint'>
                                    <div className="border-bottom p_1Estimate">
                                        ...
                                        {e?.otherAmountDetails.length > 0 && e?.otherAmountDetails.map((ele, ind) => {
                                            return <div className='d-flex word_break_estimate' key={ind}><p className='p_1Estimate w-100' key={ind}>{ele?.label} <span className='float-end'>{ele?.value}</span> </p>
                                            </div>
                                        })}
                                        {/* <p className='p_1Estimate'>Total Diamond Handling: {NumberWithCommas(e?.TotalDiamondHandling, 2)}</p> */}
                                        {e?.TotalDiamondHandling !== 0 && <p className='p_1Estimate text-end'> {NumberWithCommas(e?.TotalDiamondHandling, 2)}</p>}
                                    </div>
                                </div>
                            ...
                            <div className="labourEstimatePrint border-end position-relative">
                                <div className="h-100 d-grid pad_bot_29_estimatePrint">
                                    <div className='d-flex border-bottom'>
                                        ...
                                        {e?.settingAmount !== 0 && <>   <div className='w-50 p_1Estimate'>
                                            ...
                                            <div className='w-50 text-end p_1Estimate'>
                                                ...
                                                <p>{NumberWithCommas(e?.settingAmount, 2)}</p></div>
                                        </>}
                                    </div>
                                </div>
                                <div className="totalBgEstimatePrint position-absolute bottom-0 height_28_5_estimatePrint w-100 d-flex align-items-center justify-content-end">
                            ...
                            <div className="totalAmountEstimatePrint position-relative">
                                <div className="h-100 d-grid pad_bot_29_estimatePrint">
                                    <div className='border-bottom'>
                                        <p className='text-end p_1Estimate pe-1 fw-bold'>{NumberWithCommas(e?.TotalAmount, 2)}</p>
                                    </div>
                                </div>
                ...
                <div className="border-black border-end border-start">
                    <div className="d-flex  recordEstimatePrint overflow-hidden border-bottom" >
                        ...
                        <div className="labourEstimatePrint border-end">
                        {total?.discountAmt !== 0 && <div className="text-end">
                            <p>Total Discount</p>
                        </div>}
                        {total.previeligeCardDisocunt !== 0 && <div className="text-end">
                            ...
                            <div className='text-end'>
                                ...
                                {json1Data?.AddLess !== 0 && <p>{json1Data?.AddLess < 0 ? "Less" : "Add"}</p>}
                            </div>
                        </div>
                        ...
                        <div className="text-end">
                            ...
                            <div className='text-end'>
                                ...
                                {json1Data?.AddLess !== 0 && <p>{NumberWithCommas(json1Data?.AddLess, 2)}</p>}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="d-flex recordEstimatePrint overflow-hidden border-end border-start border-bottom  border-black" >
                    ...
                    <div className="metalEstimatePrint border-end" >
                        <div className="d-flex totalBgEstimatePrint bottom-0 w-100">
                            ...
                            <div className='width200EstimatePrint p_1Estimate h-100'><p className='fw-bold fw-bold text-end'>{fixedValues(total?.finalMetalsTotal?.Wt, 3)}</p></div>
                ...
                <div className="d-flex recordEstimatePrint overflow-hidden  border-start border-end">
                    {/* summary */}
                    <div className="min_height_100EstimatePrint border-end border-bottom position-relative col-4">
                        ...
                        <div className="d-grid h-100 pb-4">
                            <div className="d-flex w-100 justify-content-between">
                                ...
                                <div className='w-50 h-100 pb-4'>
                                    ...
                                    {json1Data?.AddLess !== 0 && <div className="d-flex justify-content-between p-1">
                                        <p className='fw-bold'>{json1Data?.AddLess > 0 ? "ADD" : "Less"}</p>
                    ...
                    {/* diamond details */}
                    <div className="min_height_100EstimatePrint border-end border-bottom position-relative col-2">
                        <div className="totalBgEstimatePrint text-center border-bottom">
                    ...
                    {/* other details */}
                    <div className="min_height_100EstimatePrint border-bottom border-end position-relative col-2">
                    ...
                    <div className="min_height_100EstimatePrint col-2">
                        {json1Data?.PrintRemark !== "" && <div className='border-bottom'> <div className="totalBgEstimatePrint text-center border-bottom"><p className="fw-bold p-1 heiht_18_8_estimatePrint">{"REMARK"}</p></div>
                            <div className="p-1">
                                <div dangerouslySetInnerHTML={{ __html: json1Data?.PrintRemark }}></div>
                            </div></div>}
                    </div>
                    {/* created by */}
                    <div className="min_height_100EstimatePrint d-flex border-start col-2 border-bottom">
