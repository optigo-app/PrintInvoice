...
const DesignsetPackinglist = ({ urls, token, invoiceNo, printName, evn, ApiVer }) => {
              ...
              <div className="btnpcl">
                <div className="mx-3 d-flex align-items-center">
                  <input
                    ...
                    id="netwt"
                  />
                  <label htmlFor="netwt" className="mx-2 user-select-none fspcl">Net Wt</label>
                  ...
                  <input
                    ...
                    id="size"
                  />
                  <label htmlFor="size" className="mx-2 user-select-none fspcl">Size</label>
                        ...
                        <tr>
                          <td>
                            <div className="pcltablehead border-start border-end border-bottom border-black ">
                              ...
                              <div className="jewpclthead fwboldpcl fspcl fspcl"> Design set </div>
                                      ...
                                      <div>
                                        {
                                          ...
                                          e?.diamonds?.map((ele, i) => {
                                            return (
                                              <div className=" fspcl text-break " key={i} > {sizeFlag && ele?.SizeName} </div>
                                            );
                                            // }
                                          })
                                        }
                                    ...
                                    <div className="w-100 d-flex h-100">
                                      ...
                                      <div style={{ width: "18%" }} className="be_1_pcl d-flex justify-content-end pt-1" >
                                        <div className="d-flex flex-column h-100 w-100 justify-content-between">
                                          <div className="w-100 end_pcl_new end_p_pcl_new">{netWtflag && (e?.totals?.metal?.IsPrimaryMetal)?.toFixed(3)}</div>
                                          <div className="w-100 end_pcl_new end_p_pcl_new bg_pcl br_top_pcl fw-bold">{netWtflag ? (e?.totals?.metal?.IsPrimaryMetal)?.toFixed(3) : "\u00A0"}</div>
                                        </div>
                                      </div>
