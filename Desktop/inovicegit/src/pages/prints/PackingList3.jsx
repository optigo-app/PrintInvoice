...
const PackingList3 = ({ urls, token, invoiceNo, printName }) => {
    ...
    dynamicList2?.length > 0 && dynamicList2.map((e, i) => {
        ...
        if (e?.MasterManagement_DiamondStoneTypeid === 2 || e?.MasterManagement_DiamondStoneTypeid === 3) {
            if (e?.MasterManagement_DiamondStoneTypeid === 3 && e?.ShapeName === 'Certification_IGI') return '';
            else {
    ...
    const organizeData = (aar, arr1, arr2) => {
        let totgrosswt = 0;
        let totnetlosswt = 0;
        let totallbrAmt = 0;
        let totalOtherAmt = 0;
        ...
        arr1.map((e, i) => {
            ...
            arr2.map((ele, ind) => {
                ...
                if (e?.SrJobno === ele?.StockBarcode) {
                    ...
                    if (ele?.MasterManagement_DiamondStoneTypeid === 3 || ele?.MasterManagement_DiamondStoneTypeid === 2) {
                        stoneNMisc.push(ele);
                            ...
                            <div className='pcl3Table'>
                                ...
                                <div>
                                    {
                                        ...
                                        resultArray?.length > 0 && resultArray.map((e, i) => {
                                                ...
                                                <>
                                                    < div className='pcl3TableCopy' key={i} >
                                                        ...
                                                        <div className='tableBodypcl3'>
                                                            <div className='th2Dpcl3'>
                                                                ...
                                                                <div><div className='fsdpcl3'>Certificate# :</div>
                                                                    <div><b className='fsdpcl3'>{e?.CertificateNo}</b></div></div>
                                                        ...
                                                        <div className='diamondPcl3 positionpcl3'>
                                                            <div>
                                                                {
                                                                    ...
                                                                    e?.diamonds?.length > 0 && e?.diamonds?.map((ele, index) => {
                                                            ...
                                                            <div className='diamondValuepcl3 positionpcl3D' style={{ width: "260px", height: "21px", border: "1px solid #989898", backgroundColor: "#eeeded", borderRight: "0px", borderLeft: "0px", borderBottom: "0px" }}>
                                                                <div className='th3Wpcl3 brRightDpcl3'></div>
                                                                <div className='th3Wpcl3 brRightDpcl3'></div>
                                                                <div className='th3Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{e?.totals?.diamonds?.Pcs}</b></div>
                                                                <div className='th3Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{e?.totals?.diamonds?.Wt?.toFixed(3)}</b></div>
                                                                ...
                                                                <div className='th3Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{e?.totals?.diamonds?.Amount?.toFixed(2)}</b></div>
                                                            </div>
                                                        </div>
                                                        {/* Metal */}
                                                            ...
                                                            <div>
                                                                {
                                                                    ...
                                                                    e?.metal?.length > 0 && e?.metal?.map((ele, index) => {
                                                                        ...
                                                                        return (
                                                                            <>
                                                                                <div className='MetalPcl3' key={index}>
                                                                                    ...
                                                                                    <div className='th4Wpcl3 brRightDpcl3 fsdpcl3'>{e?.NetWt?.toFixed(3)}</div>
                                                                                    <div className='th4Wpcl3 brRightDpcl3 fsdpcl3'>{ele?.Rate?.toFixed(2)}</div>
                                                                                    <div className='th4Wpcl3 brRightDpcl3'><b style={{ fontSize: "10px" }}>{ele?.Amount?.toFixed(2)}</b></div>
                                                                                </div>
                                                                            </>
                                                                        );
                                                                        // }
                                                                ...
                                                                }
                                                                {
                                                                    e?.LossWt === 0 ? '' :
                                                                        <div className='MetalPcl3'>
                                                                            <div className='th4Wpcl3 brRightDpcl3 fsdpcl3'>Loss</div>
                                                                            <div className='th4Wpcl3 brRightDpcl3 fsdpcl3'>{e?.LossPer?.toFixed(3)} %</div>
                                                                            <div className='th4Wpcl3 brRightDpcl3 fsdpcl3'>{e?.LossWt?.toFixed(3)}</div>
                                                                            <div className='th4Wpcl3 brRightDpcl3 fsdpcl3'></div>
                                                                            <div className='th4Wpcl3 brRightDpcl3'><b style={{ fontSize: "10px" }}>{e?.LossAmt?.toFixed(2)}</b></div>
                                                                        </div>
                                                                }
                                                            </div>
                                                            <div className='MetalPcl3 positionpcl3D' style={{ width: "201px", border: "1px solid #989898", backgroundColor: "#e8e8e8", borderBottom: "0px", borderLeft: "0px", borderRight: "0px" }}>
                                                                <div className='th4Wpcl3 brRightDpcl3'></div>

                                                                <div className='th4Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{e?.grosswt?.toFixed(3)}</b></div>
                                                                <div className='th4Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{e?.totals?.metal?.Wt?.toFixed(3)}</b></div>
                                                                <div className='th4Wpcl3 brRightDpcl3'></div>
                                                                {/* <div className='th4Wpcl3 brRightDpcl3'></div> */}
                                                                <div className='th4Wpcl3 brRightDpcl3'><b style={{ fontSize: "10px" }} >{e?.totals?.metal?.Amount?.toFixed(2)}</b></div>
                                                            </div>
                                                        ...
                                                        <div className='diamondPcl3 positionpcl3'>
                                                            <div>
                                                                {
                                                                    //stone&misc
                                                                    e?.stone_misc?.length > 0 && e?.stone_misc?.map((ele, index) => {

                                                                        return (
                                                                            <>
                                                                                {
                                                                                    ele?.ShapeName === 'Certification_IGI' ? '' :
                                                                                        <div className='diamondValuepcl3' key={index}>
                                                                                            ...
                                                                                            <div className='th3Wpcl3 brRightDpcl3 fsdpcl3'>{ele?.Wt?.toFixed(3)}</div>
                                                                                            <div className='th3Wpcl3 brRightDpcl3 fsdpcl3'>{ele?.Rate?.toFixed(2)}</div>
                                                                                            <div className='th3Wpcl3 brRightDpcl3 fsdpcl3'><b style={{ fontSize: "10px" }}>{ele?.Amount?.toFixed(2)}</b></div>
                                                                                        </div>
                                                                                }
                                                                            </>
                                                                        );
                                                            ...
                                                            <div className='diamondValuepcl3 positionpcl3D' style={{ width: "259px", height: "21px", border: "1px solid #989898", backgroundColor: "#eeeded", borderBottom: "0px", borderRight: "0px", borderLeft: "0px" }}>
                                                                <div className='th3Wpcl3 brRightDpcl3'></div>
                                                                <div className='th3Wpcl3 brRightDpcl3'></div>
                                                                <div className='th3Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{e?.totals?.stone_misc?.Pcs}</b></div>
                                                                <div className='th3Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{e?.totals?.stone_misc?.Wt?.toFixed(3)}</b></div>
                                                                <div className='th3Wpcl3 brRightDpcl3'></div>
                                                                <div className='th3Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{e?.totals?.stone_misc?.Amount?.toFixed(2)}</b></div>
                                                            </div>

                                                        </div>
                                                        <div className='labourPcl3 positionpcl3'>
                                                            {
                                                                ((e?.MaKingCharge_Unit === 0) && (e?.MakingAmount === 0)) ? '' :
                                                                    <div className='th6flex2pcl3'>
                                                        ...
                                                        e?.MiscAmount === 0 ? '' :
                                                            <div className='th6flex2pcl3'>
                                                                <div className='th6Wpcl3 brRightDpcl3 fsdpcl3' style={{ width: "130px", justifyContent: "flex-start", paddingLeft: "2px" }}>Misc</div>
                                                                <div className='th6Wpcl3 brRightDpcl3 fsdpcl3' style={{ width: "0px", justifyContent: "flex-start", paddingLeft: "2px" }}></div>
                                                                <div className='th6Wpcl3 brRightDpcl3 fsdpcl3'>{e?.MiscAmount?.toFixed(2)}</div>
                                                            </div>
                                                    } */}
                                                            {
                                                                        ...
                                                                        <>
                                                                            {
                                                                                e?.value === 0 ? '' :
                                                                                    ...
                                                                                    <div className='th6flex2pcl3'>
                                                                                        <div className='th6Wpcl3 brRightDpcl3 fsdpcl3' style={{ width: "130px", justifyContent: "flex-start", paddingLeft: "2px" }}>{e?.name}</div>
                                                                                        <div className='th6Wpcl3 brRightDpcl3 fsdpcl3' style={{ width: "0px" }}></div>
                                                                                        <div className='th6Wpcl3 brRightDpcl3 fsdpcl3'>{e?.value?.toFixed(2)}</div>
                                                                                    </div>
                                                                            }
                                                                        </>
                                                                    );
                                                            ...
                                                            <div className='th6flex2pcl3 positionpcl3D' style={{ backgroundColor: "#eeeded", border: "1px solid #989898", width: "149px", height: "21px", borderBottom: "0px", borderRight: "0px", borderLeft: "0px" }}>
                                                                <div className='th6Wpcl3 brRightDpcl3'></div>
                                                                <div className='th6Wpcl3 brRightDpcl3'></div>
                                                                <div className='th6Wpcl3 brRightDpcl3'>{totmakAmt === 0 ? '' : <b className='fsdpcl3'>{totmakAmt?.toFixed(2)}</b>}</div>
                                                            </div>
                                                        </div>
                                                        <div>
                                                            <div className='totalAndDiscountpcl3'>
                                                                <div className='th7pcl3ss'><b style={{ fontSize: "10px" }}>{e?.UnitCost?.toFixed(2)}</b></div>
                                                                <div className='th7pcl3Dis' style={{ backgroundColor: "#eeeded", border: "1px solid #989898", width: "70px", justifyContent: "flex-end", paddingRight: "2px", height: "21px", borderBottom: "0px", borderRight: "0px", borderLeft: "0px" }}><b className='fsdpcl3'>{e?.UnitCost?.toFixed(2)}</b></div>
                                                            </div>
                                    ...
                                    <div className='pcl3TableCopyD'>
                                        <div className='tableBodypcl3' style={{ backgroundColor: "#eeeded" }}>
                                            <div className='thDEpcl3'><b></b></div>
                                        </div>

                                        <div className='tableBodypcl3' style={{ backgroundColor: "#eeeded", borderBottom: "0px", height: "22px" }}>
                                            <div className='th2Dpcl3'>
                                        ...
                                        <div className='diamondPcl3 positionpcl3'>
                                            <div className='diamondValuepcl3 positionpcl3D' style={{ backgroundColor: "#eeeded", border: "1px solid #989898", width: "261px", height: "21px", borderBottom: "0px", borderTop: "0px" }}>
                                                <div className='th3Wpcl3 brRightDpcl3'></div>
                                                <div className='th3Wpcl3 brRightDpcl3'></div>
                                        ...
                                        <div className='metalPcl3 positionpcl3'>
                                            <div className='MetalPcl3 positionpcl3D' style={{ backgroundColor: "#e8e8e8", width: "201px", height: "21px", lineHeight: "10px", border: "1px solid #989898", borderBottom: "0px", borderTop: "0px", borderLeft: "0px", borderRight: "0px" }}>
                                                <div className='th4Wpcl3 brRightDpcl3'></div>
                                                <div className='th4Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{totalgrosswt?.toFixed(3)}</b></div>
                                                <div className='th4Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{totalnetlosswt?.toFixed(3)}</b></div>
                                                <div className='th4Wpcl3 brRightDpcl3'></div>
                                                {/* <div className='th4Wpcl3 brRightDpcl3'></div> */}
                                                <div className='th4Wpcl3 brRightDpcl3'><b style={{ fontSize: "10px" }}>{totalObj.totmtamt.toFixed(2)}</b></div>
                                            </div>
                                        </div>
                                        <div className='diamondPcl3 positionpcl3'>
                                            <div className='diamondValuepcl3 positionpcl3D' style={{ backgroundColor: "#e8e8e8", width: "258px" }}>
                                                <div className='th3Wpcl3 brRightDpcl3'></div>
                                                <div className='th3Wpcl3 brRightDpcl3'></div>
                                        ...
                                        <div className='labourPcl3'>
                                            <div className='th6flex2pcl3  ' style={{ backgroundColor: "#e8e8e8", width: "149px", height: "22px" }}>
                                                <div className='th6Wpcl3 brRightDpcl3'></div>
                                                <div className='th6Wpcl3 brRightDpcl3'></div>
                                                <div className='th6Wpcl3 brRightDpcl3'><b className='fsdpcl3'>{totalLbhOthAmt?.toFixed(2)}</b></div>
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                <div className='th7Dpcl3' style={{ backgroundColor: "#e8e8e8", width: "70px", fontSize: "12px", height: "22px" }}><b className='fsdpcl3'>{totalUniCostAmt?.toFixed(2)}</b></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className='sumarypcl3'>
                                    <div className='amountSummarySectionpcl3'>
                                        ...
                                        <div className='fapcl3'><div className='mrpWpcl3 fsdpcl3'>Total Amount</div><div className='mrpWpcl3 fsdpcl3'>{((+totalUniCostAmt?.toFixed(2)) - (totalObj?.totDiscount?.toFixed(2)))?.toFixed(2)}</div> </div>
                                        ...
                                        <div className='fapcl3'><div className='mrpWpcl3'><b className='fsdpcl3'>Final Amount</b></div><div className='mrpWpcl3'><b className='fsdpcl3'>{((totalUniCostAmt) - (totalObj?.totDiscount) + (headerData?.TotalCGSTAmount) + (headerData?.TotalSGSTAmount) + (headerData?.AddLess))?.toFixed(2)}</b> </div> </div>
                                    </div>
                                </div>
                                <div className='footerTotalpcl3' style={{ width: "1095px" }}>
                                    <div className='footerSummarypcl3'><div className='sumpcl3'>SUMMARY</div>
                                        <div className='flexSumpcl3'>
                                            <div className='amountSummarySectionpcl3SUM'>
                                                <div className='fapcl3D'><div className='mrpWpcl3D textrightpcl3'><b className='fsdpcl3'>GOLD IN 24KT</b></div><div className='mrpWpcl3D textrightpcl3 fsdpcl3 justify-content-end pe-1'>{totalObj.totfinewt} gm</div> </div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>GROSS WT</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalObj.totgrosswt?.toFixed(3)} gm</div> </div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>NET WT</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalnetlosswt?.toFixed(3)} gm</div> </div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>LOSS WT</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{lossWt?.toFixed(3)} gm</div> </div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>DIAMOND WT</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalObj.totdiapcs}/{totalObj.totdiawt.toFixed(3)} cts</div> </div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>STONE WT</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalObj.totcspcs}/{totalObj.totcswt.toFixed(3)} cts</div></div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>MISC WT</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalObj.totmiscpcs}/{totalObj.totmiscwt.toFixed(3)} gm</div> </div>
                                                <div className='diaDetailpcl3' style={{ width: "137pt", height: "18pt" }}></div>
                                            </div>
                                            <div className='amountSummarySectionpcl3SUM'>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>GOLD</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalObj.totmtamt.toFixed(3)}</div> </div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>DIAMOND</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalObj.totdiaamt?.toFixed(3)}</div> </div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>CST</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalObj.totcsamt?.toFixed(3)}</div></div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>MISC</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalObj.totmiscamt?.toFixed(3)}</div></div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>MAKING</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalObj.totmakingAmt?.toFixed(3)} </div> </div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>OTHER</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{totalObj.totOthAmt?.toFixed(3)}</div> </div>
                                                <div className='fapcl3D'><div className='mrpWpcl3D'><b className='fsdpcl3'>LESS</b></div><div className='mrpWpcl3D fsdpcl3 justify-content-end pe-1'>{headerData?.AddLess} </div> </div>
                                                <div className='fapcl3'><div className='mrpWpcl3 diaDetailpcl3 justify-content-start ps-1' style={{ width: "182pt" }}><b className='fsdpcl3'>TOTAL</b></div><div className='mrpWpcl3 diaDetailpcl3 justify-content-end pe-1'><b className='fsdpcl3'>{((totalUniCostAmt) - (totalObj?.totDiscount) + (headerData?.TotalCGSTAmount) + (headerData?.TotalSGSTAmount) + (headerData?.AddLess))?.toFixed(2)}</b> </div> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className='amountSummarySectionpcl3DIAM'>
                                            {
                                                ...
                                                calculatedData?.length > 0 && calculatedData?.map((e, i) => {
                                                    return (
                                                        <>
                                                            <div className='fapcl3DE' key={i}><div className='mrpWpcl3D'><b className='fsdpcl3'>{e?.ShapeName}</b></div><div className='mrpWpcl3D fsdpcl3'>{e?.totalPcs?.toFixed(2)}/{e?.totalWt?.toFixed(3)} cts</div> </div>
                                                        </>
                                                    );
                                                })
                                            }
                                    ...
                                    <div><div className='diaDetailpcl3'>OTHER DETAILS</div>
                                        <div className='amountSummarySectionpcl3DIAM'>
                                            <div className='fapcl3D'><div className='mrpWpcl3D' style={{ width: "168px" }}><b className='fsdpcl3'>RATE IN 24KT</b></div><div className='mrpWpcl3D fsdpcl3'>{headerData?.MetalRate24K?.toFixed(2)}</div> </div>
                                        </div>
                                    </div>
                                    <div><div className='diaDetailpcl3'>REMARK</div>
                                        <div className='amountSummarySectionpcl3DIAM'>
                                            <div className='fapcl3D' style={{ width: "168px" }}><div className='mrpWpcl3D' style={{ width: "168px" }}>{`${headerData?.Remark ?? ''}`}</div>
                                            </div>
                                        </div>
                                    </div>
