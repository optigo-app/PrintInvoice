    ...
    <>
        {
            loader ? <Loader /> : <>
            {
                ...
                <div className='containerji3'>
                    <div className='d-flex w-100 mt-5 mb-5 end_ji3'><Button /></div>
                                ...
                                result?.resultArray?.map((e, i) => {
                                    return (
                                        <div className='d-flex brright_ji3 brleft_ji3 brbottom_ji3 fs_ji3'>
                                            ...
                                            <div className='col2t_ji3 brright_ji3 center_ji3'>SKU</div>
                                            <div className='col3t_ji3 brright_ji3 center_ji3'>Gross Weight</div>
                                            <div className='col4t_ji3 brright_ji3 center_ji3'>Net Weight</div>
                    ...
                    <div className='mt-3 d-flex justify-content-end'>
                        <div className='w-50 brtop_ji3'>
                            ...
                            {
                                othDetails?.map((e, i) => {
                                    return  <div className='d-flex brright_ji3 brleft_ji3 brbottom_ji3 fs_ji3' key={i}>
                                    ...
                                    return (
                                        <React.Fragment key={i}>
                                        {
                                            e?.diamonds?.map((a, ind) => {
                                                return  <div className='d-flex brright_ji3 brleft_ji3 brbottom_ji3 fs_ji3' key={ind}>
                                                    <div className='col1acc_ji3 brright_ji3'></div>
                    ...
                    <div className='mt-2 p-1 brall_ji3 fs_ji3 d-flex align-items-center'>
                        <div className='fw-bold text-decoration-underline'>Remark :</div>
                        <div className='px-2'>{result?.header?.PrintRemark}</div>
                    </div>
                    <div className='d-flex mt-2 fs_ji3 justify-content-between align-items-center'>
