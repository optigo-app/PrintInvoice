    ...
    <>
      ...
      <div className="mb-5 mt-5 d-flex justify-content-end align-items-start hideBtn_s10"><button className="btn_white blue py-1" onClick={(e) => handlePrint(e)}>Print</button></div>
        ...
        <div className="border-bottom">
          <div className="headlalbel_s10 fw-bold ps-2">{result?.header?.PrintHeadLabel}</div>
          <div className="d-flex justify-content-between align-items-start p-1">
            <div className="lh_s10 fs_s10">
              <div className="fw-bold pb-1 pt-1">{result?.header?.CompanyFullName}</div>
            ...
            <div className="d-flex justify-content-end align-items-center"><img src={result?.header?.PrintLogo} className="plogo_s10" alt="" /></div>
          </div>
        </div>
        ...
        <div className="p-1 border border-top-0 fs_s10 lh_s10">
            <div className="fw-bold fs_s10_2">{result?.header?.customerfirmname}</div>
        ...
        <div>
                    ...
                    result?.resultArray?.map((e, i) => {
                        return(
                            ...
                            <div className="d-flex border border-top-0 fs_s10 ">
                                ...
                                <div className="right_s10 pad_r_s10 col3_s10 border-end">{(e?.NetWt + e?.LossWt)?.toFixed(3)}</div>	
                                ...
                                <div className="right_s10 pad_r_s10 col4_s10"><div dangerouslySetInnerHTML={{__html:result?.header?.Currencysymbol}}></div>&nbsp;{formatAmount(e?.TotalAmount)}</div>
                            </div>
                        )
                    })
                }
            ...
            <div className="d-flex fw-bold border border-top-0 fs_s10 tablehead_S10">
                ...
                <div className="right_s10 pad_r_s10 col4_s10">{formatAmount(result?.mainTotal?.total_amount)}</div>
            </div>
            {/* tax total */}
            <div className="d-flex justify-content-end align-items-center border-start border-bottom">
                <div className="fs_s10 lh_s10" style={{width:'19.15%'}}>
                    {
            ...
            <div className="tablehead_S10 d-flex justify-content-between align-items-center border border-top-0 px-1">
                ...
                <div style={{width:'19.15%'}} className="d-flex fw-bold fs_s10 h-100  border-start right_s10">
