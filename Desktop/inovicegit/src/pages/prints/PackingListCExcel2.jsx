            ...
            <div style={{paddingBottom:'5rem'}}>
                ...
                <table id='table-to-xls'>
                    <tbody>
                        ...
                        {/* table */}
                        <tr>
                            {/* <th style={{borderLeft:'1px solid #989898',borderTop:'1px solid #989898', backgroundColor:'#F5F5F5'}}>SR NO</th> */}
                            {/* <th style={{borderLeft:'1px solid #989898',borderTop:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={2}>MFG. DESIGN NO</th> */}
                            {/* <th style={{borderLeft:'1px solid #989898',borderTop:'1px solid #989898',  backgroundColor:'#F5F5F5'}} >JOB</th> */}
                            {/* <th style={{borderLeft:'1px solid #989898',borderTop:'1px solid #989898', borderBottom:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={7}>Diamond</th> */}
                            ...
                            {/* <th style={{borderLeft:'1px solid #989898',borderTop:'1px solid #989898', borderBottom:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>Labour</th> */}
                            {/* <th style={{borderLeft:'1px solid #989898',borderTop:'1px solid #989898', borderBottom:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}></th> */}
                            {/* <th style={{borderLeft:'1px solid #989898',borderTop:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}></th> */}
                        </tr>
                        <tr>
                            <th style={{borderLeft:'1px solid #989898', borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}}>SR NO</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>MFG DESIGN NO.</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>JOB NO</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>DESIGN NO.</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>IMAGES</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>CATEGORY</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>GROSS WT</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>NET WT</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>MOP & ENAMEL</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>GOLD RATE</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>GOLD AMOUNT</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>TOTAL PCS</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>TOTAL CWT</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} width={100}>QUALITY</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} width={100}>D RND PCS</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} width={100}>D RND WT</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} width={100}>D BUG PCS</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} width={100}>D BUG WT</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} width={100}>D PRS PCS</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} width={100}>D PRS WT</th>
                            ...
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}}>Amount</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}}>Rate</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}} colSpan={1}>SIZE</th>
                            <th style={{borderBottom:'1px solid #989898', borderRight:'1px solid #989898',  backgroundColor:'#F5F5F5'}}>REMARK</th>
                        </tr>
                        {
                            result2?.map((e, i) => {
                                return (<React.Fragment key={i}>
                                    ...
                                    { e?.srflag && <td width={90} style={{borderRight:'1px solid #989898'}} align='center' rowSpan={e?.srRowSpan + 1} >{e?.sr}</td>}
                                        ...
                                        <td width={120} style={{wordBreak:'break-word'}}>&nbsp;{e?.MFG_DesignNo}</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.SrJobno}&nbsp;</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.designno}&nbsp;</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.designImage}&nbsp;</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.Categoryname}&nbsp;</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.grosswt}&nbsp;</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.NetWt}&nbsp;</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.values?.totals?.colorstone?.Pcs}&nbsp;</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.metal_rate}&nbsp;</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.values?.totals?.metal?.Amount}&nbsp;</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.values?.totals?.diamonds?.Pcs}&nbsp;</td>
                                        <td width={120} align='right' style={{borderRight:'1px solid #989898', wordBreak:'break-word', paddingRight:'5px'}}>&nbsp;{e?.values?.totals?.diamonds?.Wt?.toFixed(3)}&nbsp;</td>

                                        <td width={140} align='left' >&nbsp;{(e?.diaShp?.toLowerCase() === 'rnd' || e?.diaShp?.toLowerCase() === 'bug' || e?.diaShp?.toLowerCase() === 'prs' ) && e?.diaQly}</td>

                                        <td width={140} align='left' >&nbsp;{e?.diaShp?.toLowerCase() === 'rnd' ? e?.dia_pcs : ''}</td>
                                        <td width={140} align='left'>&nbsp;{e?.diaShp?.toLowerCase() === 'rnd' && e?.dia_wt}</td>
                                        <td width={90} align='right'>&nbsp;{e?.diaShp?.toLowerCase() === 'bug' && e?.dia_pcs}</td>
                                        <td width={90} align='right'>&nbsp;{( e?.dia_wt === '' ? '' : (e?.diaShp?.toLowerCase() === 'bug' && (e?.dia_wt?.toFixed(3))))}</td>
                                        
                                        {/* <td width={90} align='right'>&nbsp;{( e?.dia_rate === '' ? '' : formatAmount(e?.dia_rate))}</td> */}
                                        <td width={90} align='right'>&nbsp;{e?.diaShp?.toLowerCase() === 'prs' && e?.dia_pcs}</td>
                                        {/* <th align='right' width={90} style={{borderRight:'1px solid #989898'}}>&nbsp;{ e?.dia_amt === '' ? '' : formatAmount(e?.dia_amt)}</th> */}
                                        <th align='right' width={90} style={{borderRight:'1px solid #989898'}}>&nbsp;{e?.diaShp?.toLowerCase() === 'prs' && e?.dia_wt}</th>
                                        ...
                                        <td width={90} align='right' style={{borderRight:'1px solid #989898'}}>&nbsp;</td>
                                        {/* <td width={90} align='right' style={{borderRight:'1px solid #989898'}}>&nbsp;{ e?.labour_rate === 0 ? '' :  formatAmount(e?.labour_rate)}</td> */}
                                        <td width={90} align='right' style={{borderRight:'1px solid #989898'}}>&nbsp;</td>
                                        {/* <td width={90} align='right' style={{borderRight:'1px solid #989898'}} colSpan={1}>&nbsp;{formatAmount(e?.labour_amt)}</td> */}
                                        <td width={90} align='right' style={{borderRight:'1px solid #989898'}} colSpan={1}>&nbsp;</td>
                                        {/* <th align='right' width={90} style={{borderRight:'1px solid #989898'}}>&nbsp;{formatAmount(e?.total_amount)}</th> */}
                                        <th align='right' width={90} style={{borderRight:'1px solid #989898'}}>&nbsp;</th>
                                    </tr>
                                    {/* dia clr materail */}
                                    
                                    {
                                        e?.matrialArr?.map((val, ind) => {
                                            return <tr key={ind}>
                                                ...
                                                <td width={90} align='left'>&nbsp;{ val?.diaflag && `${(val?.diaShp?.toLowerCase() === 'rnd' || val?.diaShp?.toLowerCase() === 'bug' || val?.diaShp?.toLowerCase() === 'prs' ) && val?.diaQly}`}</td>

                                                <td width={90} align='left'>&nbsp;{ val?.diaflag && `${val?.diaShp?.toLowerCase() === 'rnd' ? val?.dia_pcs : ''}`}</td>
                                                <td width={90} align='left'>&nbsp;{val?.diaflag && `${val?.diaShp?.toLowerCase() === 'rnd' ? val?.dia_wt : ''}`}</td>
                                                <td width={90} align='right'>&nbsp;{val?.diaflag && val?.diaShp?.toLowerCase() === 'bug' && val?.dia_pcs}</td>
                                                <td width={90} align='right'>&nbsp;{val?.diaflag && val?.diaShp?.toLowerCase() === 'bug' && val?.dia_wt}</td>
                                                {/* <td width={90} align='right'>&nbsp;{val?.diaflag && ( val?.dia_rate === '' ? '' : formatAmount(val?.dia_rate))}</td> */}
                                                <td width={90} align='right'>&nbsp;{val?.diaflag && val?.diaShp?.toLowerCase() === 'prs' && val?.dia_pcs}</td>
                                                {/* <th width={90} style={{borderRight:'1px solid #989898'}} align='right'>&nbsp;{val?.diaflag && (val?.dia_amt)}</th> */}
                                                <th width={90} style={{borderRight:'1px solid #989898'}} align='right'>&nbsp;{val?.diaflag && (val?.diaShp?.toLowerCase() === 'prs' && val?.dia_wt)}</th>
                                                ...
                                                <td width={90} style={{borderRight:'1px solid #989898'}}></td>
                                                <td width={90} style={{borderRight:'1px solid #989898'}} colSpan={1}></td>
                                                <td width={90} style={{borderRight:'1px solid #989898'}}></td>
                                            </tr>
                                        })
                                    }
                                    ...
                                    <tr>
                                        ...
                                        <th align='right' style={{borderRight:'1px solid #989898', backgroundColor:'#F5F5F5', borderTop:'1px solid #989898', borderBottom:'1px solid #989898',borderLeft:'1px solid #e8e8e8'}}>&nbsp;</th>
                                        ...
                                        {/* <th align='right' style={{borderRight:'1px solid #989898', backgroundColor:'#F5F5F5', borderTop:'1px solid #989898', borderBottom:'1px solid #989898',borderLeft:'1px solid #e8e8e8'}} colSpan={1}>&nbsp;{ e?.labour_amt === 0 ? '' : formatAmount(e?.labour_amt)}</th> */}
                                        <th align='right' style={{borderRight:'1px solid #989898', backgroundColor:'#F5F5F5', borderTop:'1px solid #989898', borderBottom:'1px solid #989898',borderLeft:'1px solid #e8e8e8'}} colSpan={1}>&nbsp;</th>
                        ...
                        <tr>
                                ...
                                <th style={{borderRight:'1px solid #989898', borderTop:'1px solid #989898', backgroundColor:'#F5F5F5', borderBottom:'1px solid #989898'}} colSpan={1} align='right'>&nbsp;{ (result?.mainTotal?.total_Making_Amount + result?.mainTotal?.diamonds?.SettingAmount + result?.mainTotal?.colorstone?.SettingAmount) === 0 ? '' : formatAmount((result?.mainTotal?.total_Making_Amount + result?.mainTotal?.diamonds?.SettingAmount + result?.mainTotal?.colorstone?.SettingAmount))}</th>
