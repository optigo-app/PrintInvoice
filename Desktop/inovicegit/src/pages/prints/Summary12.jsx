...
const Summary12 = ({ urls, token, invoiceNo, printName }) => {
  ...
  const countTotal = (arr, taxJson) => {
    ...
    // resultObj.afterTaxAmt = Math.round(
    //   resultObj.amount +
    //     sgstMinus +
    //     cgstMinus +
    //     igstMinus -
    //     Math.abs(taxJson?.AddLess)
    // );
    const AllTax = taxGenrator(taxJson, resultObj.amount);
    AllTax.forEach((e, i) => {
        resultObj.afterTaxAmt += +(e?.amount);
    })
    resultObj.afterTaxAmt += resultObj?.amount;
    setTaxTotal(AllTax);
    setTotal(resultObj);
  };
      ...
      {loader ? (
        ...
        <>
          <div className="">
            ...
            <div
              className=" pt-4 pb-5 summary12Container portrait_container"
              ref={targetRef}
              id="divToPrint"
            >
              {header && (
                <div className="d-flex header_section_sum4 justify-content-between align-items-center pb-2 no_break">
                  <div className="address_sum4">
                    <h1 className="h1_sum4">
                    ...
                    <p className="address_para_sum4 lh-1 pb-1">
                      {billPrintJson?.CompanyCity}{" "}
                      {billPrintJson?.CompanyPinCode}{" "}
              ...
              <div>
                ...
                <div className="sum4_table">
                  <div className="d-flex border-bottom no_break">
                    <div className="p-1 fw-bold ps-2 border-start border-end align-middle text-center sr_sum4">
                      SR#
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center design_sum4">
                      DESIGN
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center remark_sum4">
                      Remark
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center dia_wt_ctw_sum4">
                      DIA WT (ctw)
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center dia_rate_sum4">
                      DIA RATE
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center dia_amt_sum4">
                      DIA AMT
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center g_wt_sum4">
                      G WT (gm)
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center nwt_sum4">
                      NWT (gm)
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center other_amt_sum4">
                      Other AMT
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center cs_wt_sum4">
                      CS WT (ctw)
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center cs_rate_sum4">
                      CS RATE
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center cs_amt_sum4">
                      CS AMT
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center gold_fine_sum4">
                      GOLD FINE (gm)
                    </div>
                    <div className="p-1 fw-bold border-end align-middle text-center gold_amt_sum4">
                      GOLD AMT
                    </div>
                    <div className="p-1 fw-bold pe-2 border-end align-middle text-center amount_sum_4">
                      AMOUNT
                    </div>
                  </div>
                  {BillPrintJson1.length > 0 &&
                    BillPrintJson1.map((e, i) => {
                      return (
                        <div className="d-flex border-bottom no_break" key={i}>
                          <div className="p-1 ps-2 sr_sum4 border-start border-end sr_sum4">
                            {" "}
                            <p> {e?.SrNo} </p>{" "}
                          </div>
                          <div className="p-1 design_sum4 border-end">
                            ...
                            {e?.HUID !== "" && (
                              <p className="fw-bold"> HUID No. : ${e?.HUID}</p>
                            )}
                          </div>
                          ...
                          <div className="p-1 dia_wt_ctw_sum4 border-end text-end ">
                            {" "}
                          ...
                          <div className="p-1 dia_rate_sum4 border-end text-end ">
                            {" "}
                            {e?.diamondsRate.length > 0 &&
                              e.diamondsRate.map((ele, indd) => {
                          ...
                          <div className="p-1 g_wt_sum4 border-end text-end ">
                            {" "}
                            <p> {e?.grosswt} </p>{" "}
                          </div>
                          ...
                          <div className="p-1 cs_wt_sum4 border-end text-end ">
                          ...
                          <div className="p-1 cs_amt_sum4 border-end text-end ">
                            {" "}
                            {e?.colorStoneRate.length > 0 &&
                              e.colorStoneRate.map((ele, indd) => {
                                return <p key={indd}>{ele?.totalAmount}</p>;
                          ...
                          <div className="p-1 gold_fine_sum4 border-end text-end ">
                            ...
                            <p>
                              {" "}
                              {e?.convertednetwt &&
                                (e?.convertednetwt).toFixed(3)}{" "}
                            </p>{" "}
                          </div>
                          <div className="p-1 gold_amt_sum4 border-end text-end ">
                            {" "}
                            <p>
                              {" "}
                              {e?.MetalAmount &&
                          ...
                          <div className="p-1 pe-2 amount_sum_4 border-end text-end">
                            {e?.TotalAmount}
                          </div>
                        </div>
                      );
                  ...
                  <div className="total_sec_sum4 d-flex border-bottom mb-1 no_break">
                    <div className="p-1 ps-2 total_sum4 border-start border-end bg_total_sum4 fw-bold text-center">
                      Total
                    </div>
                    <div className="p-1 remark_sum4 border-end text-end bg_total_sum4 fw-bold remark_sum4">
                      {" "}
                      <p> </p>{" "}
                    </div>
                    <div className="p-1 dia_wt_ctw_sum4 border-end text-end bg_total_sum4 fw-bold ">
                      {" "}
                      <p> {total.diaWt} </p>{" "}
                    </div>
                    ...
                    <div className="p-1 dia_amt_sum4 border-end text-end bg_total_sum4 fw-bold ">
                      {" "}
                      <p> {Math.round(total.diaAmt)} </p>{" "}
                    </div>
                    <div className="p-1 g_wt_sum4 border-end text-end bg_total_sum4 fw-bold ">
                      {" "}
                      <p> {total.gwt.toFixed(3)} </p>{" "}
                    </div>
                    <div className="p-1 nwt_sum4 border-end text-end bg_total_sum4 fw-bold ">
                      {" "}
                      <p> {total.nwt.toFixed(3)} </p>{" "}
                    </div>
                    <div className="p-1 other_amt_sum4 border-end text-end  bg_total_sum4 fw-bold">
                      {" "}
                      <p> {total.otherAmt} </p>{" "}
                    </div>
                    <div className="p-1 cs_wt_sum4 border-end text-end bg_total_sum4 fw-bold ">
                      {" "}
                      <p> {total.csWt} </p>{" "}
                    </div>
                    ...
                    <div className="p-1 cs_amt_sum4 border-end text-end  bg_total_sum4 fw-bold">
                      {" "}
                      <p> {Math.round(total.csAmt)} </p>{" "}
                    </div>
                    <div className="p-1 gold_fine_sum4 border-end text-end  bg_total_sum4 fw-bold">
                      {" "}
                      <p> {total.goldFine.toFixed(3)} </p>{" "}
                    </div>
                    <div className="p-1 gold_amt_sum4 border-end text-end  bg_total_sum4 fw-bold">
                      {" "}
                      <p> {Math.round(total.goldAmt)} </p>{" "}
                    </div>
                    <div className="p-1 pe-2 amount_sum_4 border-end text-end bg_total_sum4 fw-bold">
                      {" "}
                      <p> {total.amount} </p>{" "}
                    </div>
                  </div>
                      ...
                      {TaxTotal?.map((e, i) => {
                        return (
                          <div className="d-flex justify-content-between px-2 pt-1">
                            <div className="sgst_text_sum4">{e?.name} {e?.per}</div>
                            {/* <div className="sgst_text_sum4"></div> */}
                            <div className="sgst_text_sum4">{e?.amount}</div>
                          </div>
                        );
                      })}
                      {/* <div className="d-flex justify-content-between px-2 pt-1">
                  ...
                  <div className="d-flex border-bottom mb-2 no_break">
                      ...
                      <div className="d-flex">
                        ...
                        <div className="gold_24kt_sum4 w-50">
                          <div className="d-flex w-100">
                            ...
                            <div className="w-50 text-end pe-2">
                              {total.goldAmt.toFixed(3)}
                            </div>
                          </div>
                          <div className="d-flex w-100">
                            <div className="w-50 fw-bold ps-2">DIAMOND</div>
                            <div className="w-50 text-end pe-2">
                              {Math.round(total.diaAmt)}
                            </div>
                          </div>
                          <div className="d-flex w-100">
                          ...
                          <div className="d-flex w-100">
                            ...
                            <div className="w-50 text-end pe-2">
                              {totalSummary?.makingAmount?.toFixed(3)}
                            </div>
                          </div>
                          <div className="d-flex w-100">
                            <div className="w-50 fw-bold ps-2">OTHER</div>
                            <div className="w-50 text-end pe-2">
                              {total.otherAmt.toFixed(2)}
                            </div>
                          </div>
                          <div className="d-flex w-100 mb-2">
                    ...
                    <div className="cgst_sum4 border">
                      <div className="bg_total_sum4 d-flex py-1">
                        ...
                        <div className="dia_wt_sum4 fw-bold">Dia Wt (ctw)</div>
                        <div className="GWt_sum4 fw-bold">GWt (gm)</div>
                        <div className="net_wt_sum4 fw-bold">Net Wt (gm)</div>
                        <div className="fine_wt_sum4 fw-bold">Fine Wt (gm)</div>
                      ...
                      {metalType.length > 0 &&
                        metalType.map((e, i) => {
                          return (
                            <div className=" d-flex py-1" key={i}>
                  ...
                  <p className="fw-bold pb-1 no_break">TERMS INCLUDED :</p>
                    ...
                    <>
                      <div className="summary_table_sum4 w-100 no_break">
                        ...
                        {metalType.length > 0 &&
                          metalType.map((e, i) => {
                            return (
                              <div className="d-flex border no_break" key={i}>
                        ...
                        <div className="d-flex border height34Sum4 bg_total_sum4 ">
                          ...
                          <div className="tunchSum4 border-end d-flex align-items-center justify-content-end pe-2 fw-bold"></div>
                          ...
                          <div className="goldPriceSum4 border-end d-flex align-items-center justify-content-end pe-2 fw-bold"></div>
                            ...
                            lastDiamondTable.map((e, i) => {
                              return (
                                <div className="d-flex border" key={i}>
                                  ...
                                  <div className="DiamondCtwSum4 d-flex justify-content-end pe-2 align-items-center border-end">
                                    {e?.totalWeight}
                                  </div>
                                  <div className="DiamondPriceSum4 d-flex justify-content-end pe-2 align-items-center border-end">
                                    {e?.rate}
                                  </div>
                                  <div className="DiamondDiscountSum4 d-flex justify-content-end pe-2 align-items-center border-end">
                                    {e?.discount} %
                                  </div>
                                  <div className="DiamondAmountSum4 d-flex justify-content-end pe-2 align-items-center">
                                    {e?.totalAmount}
                                  </div>
                                </div>
                              );
