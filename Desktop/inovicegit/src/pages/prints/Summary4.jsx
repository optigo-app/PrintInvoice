            ...
            <div className="">
              ...
              <div className="sum4_table">
                <div className="d-flex border-bottom">
                  <div className="p-1 ps-2 border-start border-end align-middle text-center sr_sum4 fw-bold font_alignment_Setting">
                    SR#
                  </div>
                  <div className="p-1 border-end align-middle text-center design_sum4 fw-bold font_alignment_Setting">
                    DESIGN
                  </div>
                  {/* <div className="p-1 border-end align-middle text-center remark_sum4 fw-bold"> */}
                  <div
                    className={`p-1 border-end align-middle text-center fw-bold font_alignment_Setting ${
                  ...
                  <div
                    className="p-1 border-end align-middle text-center dia_wt_ctw_sum4 fw-bold font_alignment_Setting"
                    style={{ wordBreak: "break-word" }}
                  >
                    DIA WT (ctw)
                  </div>
                  <div className="p-1 border-end text-center dia_rate_sum4 flex-column d-flex align-items-center justify-content-center fw-bold font_alignment_Setting">
                    <div>DIA </div>
                    <div>RATE</div>
                  </div>
                  <div className="p-1 border-end text-center dia_amt_sum4 flex-column d-flex align-items-center justify-content-center fw-bold">
                    <div>DIA </div>
                    <div>AMT</div>
                  </div>
                  <div className="p-1 border-end text-center g_wt_sum4 flex-column d-flex align-items-center justify-content-center fw-bold">
                    <div>G WT </div>
                    <div>(gm)</div>
                  </div>
                  <div className="p-1 border-end text-center nwt_sum4 flex-column d-flex align-items-center justify-content-center fw-bold">
                    <div>NWT </div>
                    <div>(gm)</div>
                  </div>
                  <div className="p-1 border-end text-center other_amt_sum4 flex-column d-flex align-items-center justify-content-center fw-bold">
                    <div>Other </div>
                    <div>AMT</div>
                  </div>
                  <div className="p-1 border-end text-center cs_wt_sum4 flex-column d-flex align-items-center justify-content-center fw-bold">
                    <div>CS WT </div>
                    <div>(ctw)</div>
                  </div>
                  <div className="p-1 border-end text-center cs_rate_sum4 flex-column d-flex align-items-center justify-content-center fw-bold">
                    <div>CS </div>
                    <div>RATE</div>
                  </div>
                  <div className="p-1 border-end text-center cs_amt_sum4_new flex-column d-flex align-items-center justify-content-center fw-bold">
                    <div>CS </div>
                    <div>AMT</div>
                  </div>
                  {makingColumShow && (
                  ...
                  <div className="p-1 pe-2 border-end align-middle text-center amount_sum_4 fw-bold font_alignment_Setting">
                    AMOUNT
                  </div>
                </div>
                    ...
                    return (
                      <div className="d-flex border-bottom" key={i}>
                        ...
                        <div className="p-1 design_sum4 border-end">
                          ...
                          {e?.Categoryname && (
                            <p className="fw-bold design_name_show">{e?.Categoryname}</p>
                          )}
                          {image && (
                            <img
                              src={e?.DesignImage}
                        ...
                        >
                          {e?.HUID !== "" && (
                            <p>
                              {" "}
                              <strong>HUID</strong> - <p>{e?.HUID}</p>
                            </p>
                          )}
                          {e?.CertificateNo !== "" && (
                            <p>
                              {/* <span className="fw-bold">IGI-</span> */}
                              <span className="word_break_setting"> {e?.CertificateNo}</span>
                            </p>
                          )}
                          <p>{e?.CertRemark} </p>
                        </div>
                        ...
                        <div className="p-1 cs_amt_sum4_new border-end text-end ">
                          {" "}
                          {e?.colorStoneRate.length > 0 &&
                            e.colorStoneRate.map((ele, indd) => {
                              return (
                        ...
                        {makingColumShow && (
                          ...
                          >
                            <div className="d-flex">
                              <div
                                className="w-40 end_dp10 pr_dp10 gap-2"
                                style={{
                                  display: "flex",
                                  flexDirection: "column",
                                }}
                              >
                                <p>{formatAmount(e?.MaKingCharge_Unit)}</p>
                                <p>{e?.SettingRate?.toFixed(2)}</p>
                              </div>
                              <div
                                className="w-60 end_dp10 pr_dp10 gap-2"
                                style={{
                                  display: "flex",
                                  flexDirection: "column",
                                }}
                        ...
                        <div className="p-1 gold_amt_sum4 border-end text-end ">
                          {" "}
                          <p> {NumberWithCommas(e?.MetalAmount, 2)} </p>{" "}
                        </div>
                ...
                <div className="total_sec_sum4 d-flex border-bottom mb-1">
                  ...
                  <div
                    className="p-1 dia_amt_sum4 border-end text-end bg_total_sum4 fw-bold "
                    style={{ display: "flex", justifyContent: "flex-end" }}
                  >
                    {" "}
                  ...
                  <div
                    className="p-1 other_amt_sum4 border-end text-end  bg_total_sum4 fw-bold"
                    style={{
                      width: "7%",
                      display: "flex",
                  ...
                  <div
                    className="p-1 pe-2 amount_sum_4 border-end text-end bg_total_sum4 fw-bold"
                    style={{ display: "flex", justifyContent: "flex-end" }}
                  >
                    {" "}
                  ...
                  <div className="summary_detail_sum4 border">
                    ...
                    <div className="d-flex">
                      <div className="gold_24kt_sum4 w-50 border-end">
                        ...
                        <div className="d-flex w-100">
                          <div className="w-60 fw-bold ps-2">DIAMOND WT</div>
                          <div className="w-40 text-end pe-2">
                            {NumberWithCommas(totalSummary?.diamondpcs, 0)} /{" "}
                        ...
                        <div className="d-flex w-100 mb-3">
                          ...
                          <div className="w-40 text-end pe-2">
                            {NumberWithCommas(totalSummary?.colorStonePcs, 0)} /{" "}
                  ...
                  <>
                    <div className="summary_table_sum4 w-100">
                      ...
                      {metalType.length > 0 &&
                        metalType.map((e, i) => {
                          return (
                            <div className="d-flex border-start border-end" key={i}>
                    ...
                    <div className="d-flex mt-2 justify-content-between">
                      <div className="diamondTypeSum4">
                        ...
                        <div className="d-flex height34Sum4 border bg_total_sum4">
                          ...
                          <div className="DiamondCtwSum4 d-flex justify-content-end align-items-center border-end fw-bold px-2">
                          ...
                          <div className="DiamondAmountSum4 d-flex justify-content-end align-items-center fw-bold px-2">
                            {NumberWithCommas(
