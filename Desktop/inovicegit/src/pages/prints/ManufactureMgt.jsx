          ...
          if (ele?.StockBarcode === e?.SrJobno) {
            if (ele?.MasterManagement_DiamondStoneTypeid === 4) {
              ...
              repairedJewelleryNetWt +=
                ele?.Wt + ele?.WtAdd - ele?.DetachWeight;
              ...
              return (
                ...
                >
                  ...
                  <div className="col-7 border-end">
                    ...
                    <p className="px-1 py-2 no_break">
                      {e?.netDetach !== 0 &&
                        `Net: ${NumberWithCommas(
                          e?.netDetach,
                          3
                        )} gms NW | DIA: `}
                      {e?.diamondDetach !== 0 &&
                        `${NumberWithCommas(e?.diamondDetach, 3)} Cts | CS: `}
                      {e?.colorStoneDetach !== 0 &&
                        `${NumberWithCommas(e?.colorStoneDetach, 3)} Cts`}
                    </p>
                  </div>
                  <div className="col-2">
