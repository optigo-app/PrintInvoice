      ...
      <div className="d-flex justify-content-between align-items-start fs_dp3 dp3_pgia " style={{marginTop:'2px'}}>
        <div className="d-flex" style={{width:'50%'}}>
          ...
          <div className="border-secondary border-top" style={{width:'35%'}}>
            ...
            <div className="border-secondary border-bottom border-end pad_s_dp3 ps-2 text-break" dangerouslySetInnerHTML={{ __html: (result?.header?.PrintRemark === '' ? '&nbsp;' : result?.header?.PrintRemark) }}></div>
          </div>
        </div>
