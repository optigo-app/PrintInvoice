  ...
  return (
    <>{loader ? <Loader /> : <div className="container containerDetailPrint1 pt-4">
      ...
      <div className="d-flex w-100 border-top border-2 recordDetailPrint1">
        <div className="srNoDetailprint11 border-end border-start border-2 border-bottom d-flex justify-content-center align-items-center">
          <p className='fw-bold'>Sr. </p>
          <p className='fw-bold'>No. </p>
        </div>
        <div className="designDetalPrint1 border-end border-2 p-1 border-bottom d-flex justify-content-center align-items-center">
          <p className='fw-bold p-1'>Design</p>
        </div>
        <div className="diamondDetailPrint1 border-end border-2">
          <div className="d-grid h-100">
            ...
            <div className='d-flex border-bottom border-2'>
              <p className='fw-bold col-2 d-flex align-items-center justify-content-center border-end border-2'>Code</p>
        ...
        <div className="metalGoldDetailPrint1 border-end border-2">
          <div className="d-grid h-100">
        ...
        <div className="otherAmountDetailPrint1 border-end border-2 border-bottom d-flex align-items-center justify-content-center flex-column">
        ...
        <div className="labourAmountDetailPrint1 border-end border-2 border-bottom">
          <div className="d-grid h-100">
      ...
      {json1Data.length > 0 && json1Data.map((e, i) => {
        return <div key={i} className='recordDetailPrint1'>
          <div className="d-flex w-100">
            ...
            <div className="designDetalPrint1 border-end border-2 p-1 border-bottom">
              <div className="d-flex">
                <div className='col'>
                  <p>{e?.designno}</p>
                </div>
            ...
            <div className="diamondDetailPrint1 border-end border-2 position-relative">
            ...
            <div className="metalGoldDetailPrint1 border-end border-2 position-relative">
              <div className="h-100 paddingBottomTotalDetailPrint1">
              ...
              <div className="h-100 paddingBottomTotalDetailPrint1">
                {e?.colorStones.length > 0 && e?.colorStones.map((ele, ind) => {
                  return <div className={`d-flex`} key={ind}>
                    ...
                    <p className='col-2 text-center border-2'>{ele?.SizeName}</p>
                    <p className='col-1 border-2 text-end'>{ele?.Pcs}</p>
                    <p className='col-2 border-2 text-end'>{ele?.Wt}</p>
                    <p className='col-2 border-2 text-end'>{ele?.Rate}</p>
                    <p className='col-2 text-end'>{ele?.Amount}</p>
                  </div>
                })}
            ...
            <div className="otherAmountDetailPrint1 border-end border-2 position-relative">
            ...
            <div className="labourAmountDetailPrint1 border-end border-2 position-relative">
          ...
          <div className="d-flex w-100">
            ...
            <div className="diamondDetailPrint1 border-end border-2 position-relative border-bottom">
              <div className="d-grid">
              </div>
            </div>
            <div className="metalGoldDetailPrint1 border-end border-2 position-relative border-bottom">
            ...
            <div className="otherAmountDetailPrint1 border-end border-2 border-bottom">
      ...
      <div className="d-flex w-100 recordDetailPrint1">
        <div className="designDetalPrint1Total border-end border-2 border-bottom border-start">
        ...
        <div className="metalTotalDetailPrint1 border-end border-2 position-relative border-bottom">
          <div className='d-flex'>
        ...
        <div className="diamondDetailPrint1 border-end border-2 position-relative border-bottom">
          <div className='d-flex'>
            ...
            <p className='col-2 border-2 text-end'>{(total?.colorStoneWt).toFixed(2)}</p>
            <p className='col-2 border-2 text-end'></p>
          ...
          <div className="d-flex border-end border-2">
            ...
            <div className="col-6 position-relative summaryPadBotDetailPrint1 border-2 d-flex flex-column">
              ...
              <div className="d-flex justify-content-between border-top border-2 position-absolute w-100 border-bottom  bottom-0 totalLineDetailPrint1">
                ...
                <p className='p-1'>{(summary?.total).toFixed(2)}</p>
              </div>
            </div>
          </div>
        </div>
