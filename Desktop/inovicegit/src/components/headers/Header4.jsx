  ...
  return (
    <div className="p-2">
      ...
      <div className={style.qrcodeheadh4}>
        ...
        <div className={style.qrcodeheadimgh4}>QR CODE</div>
      </div>
      ...
      <div className={style.companydetailh4}>
            ...
            <div>
              ...
              <div className={style.companyInfoCenterh4}>Surat-395004, {headerData?.CompanyState}({headerData?.CompanyCountry})</div>
              <div className={style.companyInfoCenterh4}>T {headerData?.CompanyTellNo}</div>
              <div className={style.companyInfoCenterh4}>GSTIN-24AAECE4223C1ZB | {headerData?.Company_CST_STATE} - {headerData?.Company_CST_STATE_No}</div>
