                  ...
                  <div key={i} className="disflx spbrlFt brBtom spfntbH">
                    {isFindingOrMount ? (
                      ...
                      <>
                        ...
                        <div className={`${rateFlag ? 'RTSucol4FnDMnt_inv2' : ''} Sucol4FnDMnt_inv2 spbrRht spbrWord`} style={{width:"9.45%"}}>{e?.shape === "" || e?.ItemName?.toLowerCase() === "metal" || e?.ItemName?.toLowerCase() === "alloy" || allowedNames.includes(e?.ItemName?.toLowerCase()) ? "-" : e?.shape}</div>
